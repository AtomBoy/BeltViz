...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function jc(){return new on({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Kl(),fragmentShader:`
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function Zc(){return new on({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Kl(),fragmentShader:`
...
`;function ju(i,t){const e=window.devicePixelRatio??1,n={leo:[],meo:[],geo:[],heo:[],other:[]},s=new Array(t.length);for(let A=0;A<t.length;A++){const I=t[A].orbitClass,D=n[I].length;n[I].push(A),s[A]={orbitClass:I,localIndex:D}}const r={},o=new Mn;i.add(o);for(const A of ks){const I=n[A].length;if(I===0){r[A]=null;continue}const D=new Ee,L=new Float32Array(I*3),F=new Float32Array(I*3),N=new Float32Array(I),G=Rh[A],V=A==="geo"?14:A==="heo"?12:11;for(let B=0;B<I;B++)F[B*3]=G.r,F[B*3+1]=G.g,F[B*3+2]=G.b,N[B]=V,L[B*3+1]=-2;const nt=new de(L,3),q=new de(F,3),Q=new de(N,1);nt.setUsage(Gs),q.setUsage(Gs),Q.setUsage(Gs),D.setAttribute("position",nt),D.setAttribute("satColor",q),D.setAttribute("satSize",Q);const ot=new on({uniforms:{uDPR:{value:e}},vertexShader:oM,fragmentShader:aM,transparent:!0,blending:ti,depthWrite:!1}),ut=new du(D,ot);ut.frustumCulled=!1,o.add(ut),r[A]={points:ut,posAttr:nt,colorAttr:q,sizeAttr:Q,baseColor:G,baseSize:V}}let a=-1,l=null,c=null,h=null,u=1,d=0,p=1e4,g=0,_=0,m=null;const f=2e3;function y(A,I){if(!A||I===0)return;const D=performance.now(),L=Math.min(I,t.length);if(!h){h=new Float32Array(t.length*3),c=new Float32Array(t.length*3);for(let N=0;N<L;N++)h[N*3]=A[N*3],h[N*3+1]=A[N*3+1],h[N*3+2]=A[N*3+2];c.set(h),d=D,u=1,M(h);return}d>0&&(p=Math.max(200,D-d)),d=D;const F=c;c=h,h=F;for(let N=0;N<L;N++)h[N*3]=A[N*3],h[N*3+1]=A[N*3+1],h[N*3+2]=A[N*3+2];u=0}function M(A){for(let I=0;I<t.length;I++){const D=s[I];if(!D)continue;const L=r[D.orbitClass];if(!L)continue;const F=D.localIndex;L.posAttr.array[F*3]=A[I*3],L.posAttr.array[F*3+1]=A[I*3+1],L.posAttr.array[F*3+2]=A[I*3+2]}for(const I of ks)r[I]&&(r[I].posAttr.needsUpdate=!0)}function x(A){if(!h||!c||u>=1)return;u=Math.min(1,(A-d)/p);const I=u,D=1-I;for(let L=0;L<t.length;L++){const F=s[L];if(!F)continue;const N=r[F.orbitClass];if(!N)continue;const G=F.localIndex;N.posAttr.array[G*3]=c[L*3]*D+h[L*3]*I,N.posAttr.array[G*3+1]=c[L*3+1]*D+h[L*3+1]*I,N.posAttr.array[G*3+2]=c[L*3+2]*D+h[L*3+2]*I}for(const L of ks)r[L]&&(r[L].posAttr.needsUpdate=!0)}function w(A){if(a>=0&&a<t.length){const I=s[a],D=r[I.orbitClass];if(D){const L=I.localIndex,F=D.baseColor;D.colorAttr.array[L*3]=F.r,D.colorAttr.array[L*3+1]=F.g,D.colorAttr.array[L*3+2]=F.b,D.sizeAttr.array[L]=D.baseSize,D.colorAttr.needsUpdate=!0,D.sizeAttr.needsUpdate=!0}}if(a=A,A>=0&&A<t.length){const I=s[A],D=r[I.orbitClass];if(D){const L=I.localIndex;D.colorAttr.array[L*3]=Ea.r,D.colorAttr.array[L*3+1]=Ea.g,D.colorAttr.array[L*3+2]=Ea.b,D.sizeAttr.array[L]=D.baseSize*2.5,D.colorAttr.needsUpdate=!0,D.sizeAttr.needsUpdate=!0}}}function E(A,I){if(P(),!A||A.length<6)return;const D=new Ee;D.setAttribute("position",new de(A.slice(),3)),_=A.length/3,g=1,D.setDrawRange(0,1);const L=Rh[I]??new Ot(16777215),F=new uu({color:L,transparent:!0,opacity:.8,depthWrite:!1});l=new jf(D,F),l.frustumCulled=!1,i.add(l),m=performance.now()}function C(A){if(!l||g>=_)return;const I=A-m,D=Math.min(1,I/f);g=Math.max(2,Math.floor(D*_)),l.geometry.setDrawRange(0,g)}function P(){l&&(i.remove(l),l.geometry.dispose(),l.material.dispose(),l=null),g=0,_=0,m=null}function S(A){var D;const I={leo:A.showLeo,meo:A.showMeo,geo:A.showGeo,heo:A.showHeo,other:A.showOther};for(const L of ks)r[L]&&(r[L].points.visible=I[L]);if(a>=0){const L=(D=s[a])==null?void 0:D.orbitClass;L&&!I[L]&&P()}}function v(){P();for(const A of ks){const I=r[A];I&&(I.points.geometry.dispose(),I.points.material.dispose())}i.remove(o)}return{group:o,updatePositions:y,lerpPositions:x,setSelected:w,setOrbitTrace:E,tickOrbitTrace:C,clearOrbitTrace:P,applyVisibility:S,dispose:v,getSelectedGlobalIndex:()=>a}}function lM(i,t,e,n){const s=t.trim().toLowerCase(),r=new Set(e);return i.filter(o=>{if(!r.has(o.orbitClass)||n&&!o.notable)return!1;if(s){const a=o.name.toLowerCase().includes(s),l=String(o.id).includes(s);if(!a&&!l)return!1}return!0})}function Ql(i){return{leo:"LEO",meo:"MEO",geo:"GEO",heo:"HEO",other:"OTHER"}[i]??i.toUpperCase()}function cM(i,t){return i.findIndex(e=>e.id===t)}function tc(i){const t=parseFloat(i.substring(52,63));return!isFinite(t)||t<=0?0:1440/t}const hM={leo:"#3a6080",meo:"#1a6050",geo:"#706020",heo:"#602060",other:"#404040"};let Ze=null,yi=null,Je=null,yn=null,Zs=!1,Ei=[],Zu="",Al=["leo","meo","geo","heo"],Ju=!0,Hs=null,Ph=null;function uM(){if(document.getElementById("sat-panel-styles"))return;const i=document.createElement("style");i.id="sat-panel-styles",i.textContent=`
  ...
  `,document.head.appendChild(i)}function dM(){uM(),Ze=document.createElement("div"),Ze.id="sat-panel";const i=document.createElement("div");i.id="sat-panel-header";const t=document.createElement("div");t.id="sat-panel-title",t.innerHTML="<span>Satellite Search</span>";const e=document.createElement("span");e.id="sat-panel-close",e.textContent="✕",e.addEventListener("click",io),t.appendChild(e),i.appendChild(t),Je=document.createElement("input"),Je.id="sat-search",Je.type="text",Je.placeholder="Search name or NORAD ID…",Je.autocomplete="off",Je.spellcheck=!1,Je.addEventListener("input",fM),i.appendChild(Je),Ze.appendChild(i),yi=document.createElement("div"),yi.id="sat-results",Ze.appendChild(yi),yn=document.createElement("div"),yn.id="sat-selected-info",yn.style.display="none",Ze.appendChild(yn),document.body.appendChild(Ze),document.addEventListener("keydown",n=>{n.key==="Escape"&&Zs&&io()}),document.addEventListener("mousedown",n=>{if(Zs&&Ze&&!Ze.contains(n.target)){if(n.target.closest&&n.target.closest("#sat-open-btn"))return;io()}})}function fM(){clearTimeout(Ph),Ph=setTimeout(()=>{Zu=Je.value,Ro()},200)}function Ro(){const i=[];Al&&i.push(...Al);const t=lM(Ei,Zu,i,Ju);if(yi.innerHTML="",t.length===0){const s=document.createElement("div");s.className="sat-no-results",s.textContent="No satellites match.",yi.appendChild(s);return}const e=80,n=t.slice(0,e);for(const s of n){const r=Ei.indexOf(s),o=document.createElement("div");o.className="sat-result-row",r===ec&&o.classList.add("selected");const a=document.createElement("span");a.className="sat-result-name",a.title=s.name,a.textContent=s.name;const l=document.createElement("span");l.className="sat-class-badge",l.textContent=Ql(s.orbitClass),l.style.background=hM[s.orbitClass]??"#404040",l.style.color="#c8ddf0",o.appendChild(a),o.appendChild(l),o.addEventListener("click",()=>pM(r)),yi.appendChild(o)}if(t.length>e){const s=document.createElement("div");s.className="sat-no-results",s.textContent=`… and ${t.length-e} more. Refine search.`,yi.appendChild(s)}}let ec=-1;function pM(i){if(ec=i,Ro(),i<0||i>=Ei.length){yn.style.display="none",Hs&&Hs(-1);return}const t=Ei[i],e=tc(t.line2),n=Qu(t.line2);yn.style.display="block",yn.innerHTML=`
  ...
  `,Hs&&Hs(i)}function Qu(i){const t=parseFloat(i.substring(52,63));if(!isFinite(t)||t<=0)return 0;const e=398600.4418,n=t*2*Math.PI/86400,s=Math.pow(e/(n*n),1/3);return Math.max(0,s-6371.2)}function td(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function mM(i,t={}){Ei=i,Hs=t.onSelect??null,dM(),Ro()}function gM(){Ze&&(Ze.classList.add("visible"),Zs=!0,Je==null||Je.focus())}function io(){Ze&&(Ze.classList.remove("visible"),Zs=!1)}function _M(){Zs?io():gM()}function vM(i,t){Al=i,Ju=t,Ro()}function xM(i){if(ec=i,i>=0&&i<Ei.length){const t=Ei[i],e=tc(t.line2),n=Qu(t.line2);yn.style.display="block",yn.innerHTML=`
      <div class="sat-info-name">${td(t.name)}</div>
    ...
    `}else yn.style.display="none"}const Z={maxDegree:13,numLatitudes:4,numLongitudes:8,tubeRadius:.008,showFieldLines:!0,autoRotate:!1,showIsosurfaces:!1,isoMode:"lShell",isoResolution:64,isoOpacity:.2,isoLevels:{},showInnerBelt:!1,showOuterBelt:!1,beltOpacity:.15,clipEquatorial:!1,clipMeridional:!1,clipMeridionalAngle:0,solarWindEnabled:!0,solarWindSpeed:400,solarWindDensity:5,imfBy:0,imfBz:0,dst:0,g1:0,g2:0,sunLongitude:0,sunDeclination:0,showMagnetopause:!1,datetimeString:"2025-11-06T00:00",particles:{enabled:!1,showElectrons:!0,showProtons:!0,count:800,energyMeV:1},aurora:{enabled:!1,opacity:1},satellites:{enabled:!1,showLeo:!0,showMeo:!0,showGeo:!0,showHeo:!0,showOther:!1,notableOnly:!0}},{params:rn,isoLevels:Lh,camera:Xr}=iM();rn.particles&&(Object.assign(Z.particles,rn.particles),delete rn.particles);rn.aurora&&(Object.assign(Z.aurora,rn.aurora),delete rn.aurora);rn.satellites&&(Object.assign(Z.satellites,rn.satellites),delete rn.satellites);Object.assign(Z,rn);function ed(){if(Z.isoLevels={},Z.isoMode==="lShell")for(const i of yv)Z.isoLevels[i]=[2,4,6,10].includes(i);else for(const i of Mv)Z.isoLevels[i]=[1e4,5e3,2e3,500].includes(i)}ed();function Js(){return Z.solarWindEnabled?{enabled:!0,vSw:Z.solarWindSpeed,nSw:Z.solarWindDensity,imfBy:Z.imfBy,imfBz:Z.imfBz,dst:Z.dst,g1:Z.g1,g2:Z.g2,sunLonRad:Z.sunLongitude*Math.PI/180,ps:Z.sunDeclination*Math.PI/180}:null}const MM=[[55],[40,65],[30,50,70],[25,40,55,70],[20,35,50,60,72],[20,30,42,54,64,75],[18,28,38,48,58,68,78],[15,24,33,42,51,60,69,78],[14,22,30,38,46,54,62,70,78],[12,20,28,36,44,52,60,68,74,80],[12,19,26,33,40,47,54,61,68,74,80],[10,17,24,31,38,45,52,59,66,72,78,82]],Vn=new T1({antialias:!0});Vn.setPixelRatio(window.devicePixelRatio);Vn.setSize(window.innerWidth,window.innerHeight);Vn.toneMapping=zh;Vn.toneMappingExposure=1;Vn.localClippingEnabled=!0;document.body.appendChild(Vn.domElement);const me=new qf;me.background=new Ot(8);const fe=new tn(45,window.innerWidth/window.innerHeight,.01,500);fe.position.set(0,1.5,4);w1(me);const{sunLight:yM}=D1(me),qs=C1(me),Dh=R1(me),Po=$1(fe,Vn);Xr&&(fe.position.set(Xr.x,Xr.y,Xr.z),Po.update());Po.addEventListener("change",()=>De(Z,fe));const xo=Fv();let Pe=null,nd=0,id=8200,qr=null,ke=null,Mo=null,Tl=null;function sd(i,t){const{epochs:e,g:n,h:s,sv_g:r,sv_h:o,svEpoch:a,nmax:l,referenceRadius:c}=i;if(t>=a){const d=t-a,p=e.length-1;return{epoch:t,nmax:l,referenceRadius:c,sv_g:r,sv_h:o,g:n[p].map((g,_)=>g.map((m,f)=>m+d*r[_][f])),h:s[p].map((g,_)=>g.map((m,f)=>m+d*o[_][f]))}}let h=e.length-2;for(let d=0;d<e.length-1;d++)if(t>=e[d]&&t<e[d+1]){h=d;break}const u=(t-e[h])/(e[h+1]-e[h]);return{epoch:t,nmax:l,referenceRadius:c,sv_g:r,sv_h:o,g:n[h].map((d,p)=>d.map((g,_)=>g+u*(n[h+1][p][_]-g))),h:s[h].map((d,p)=>d.map((g,_)=>g+u*(s[h+1][p][_]-g)))}}function rd(i){if(!Mo)return;const t=i.getUTCFullYear();t!==Tl&&(Tl=t,ke=sd(Mo,t))}async function SM(){Mo=await(await fetch("./data/igrf/igrf14-all.json")).json();const t=new Date(Z.datetimeString).getUTCFullYear();Tl=t,ke=sd(Mo,t)}function bM(){return qr||(qr=new Worker(new URL(""+new URL("fieldLineWorker-DQ34Blhd.js",import.meta.url).href,import.meta.url),{type:"module"}),qr.onmessage=EM),qr}function EM(i){const{type:t,buildId:e,tracedLines:n}=i.data;if(t!=="fieldLinesReady"||e!==nd)return;const s=n.filter(a=>a.points.length>=2);Pe!==null&&Pe.children.length===s.length?AM(s,id):od(s);const o=document.getElementById("loading");o&&(o.style.display="none")}function Lo(i=8200,t=!0){const e=++nd;if(id=i,t){const r=document.getElementById("loading");r&&(r.style.display="")}const n=Js(),s=Z.solarWindEnabled;bM().postMessage({buildId:e,latitudes:MM[Z.numLatitudes-1],nLongitudes:Z.numLongitudes,bothHemispheres:s,polarCapLatitudes:s?[85,88]:[],coeffs:ke,maxDegree:Z.maxDegree,solarWindParams:n})}function od(i){Kn=null,Pe&&(me.remove(Pe),Pe.traverse(t=>{t.geometry&&t.geometry.dispose(),t.material&&t.material.dispose()}),Pe=null),Pe=Y1(i,Uu,{radius:Z.tubeRadius}),Pe.visible=Z.showFieldLines,me.add(Pe),Pe.children.forEach((t,e)=>{t.userData.isOpen=i[e].isOpen??!1}),gd()}function AM(i,t=8200){const e=[];for(let n=0;n<Pe.children.length;n++){const s=Pe.children[n],r=i[n],o=Iu(r.points,{color:Uu(r.lat),radius:Z.tubeRadius,tubularSegments:Du});if(!o){od(i);return}const a=s.userData.isOpen??!1,l=r.isOpen??!1,c=a!==l,h=c?LM:t,u=c?IM:DM;s.userData.isOpen=l,e.push({mesh:s,oldPos:s.geometry.attributes.position.array.slice(),newPos:o.geometry.attributes.position.array.slice(),lineDuration:h,easing:u}),o.geometry.dispose(),o.material.dispose()}Kn={startTime:performance.now(),duration:Math.max(...e.map(n=>n.lineDuration)),lines:e}}function TM(i){if(!Kn)return;const t=i-Kn.startTime,e=t/Kn.duration;for(const{mesh:n,oldPos:s,newPos:r,lineDuration:o,easing:a}of Kn.lines){const l=Math.min(1,t/o),c=a(l),h=n.geometry.attributes.position.array;for(let u=0;u<h.length;u++)h[u]=s[u]+c*(r[u]-s[u]);n.geometry.attributes.position.needsUpdate=!0,n.geometry.computeVertexNormals(),n.geometry.computeBoundingSphere()}e>=1&&(Kn=null)}function ad(){Pe&&(Pe.visible=Z.showFieldLines),Po.autoRotate=Z.autoRotate,De(Z,fe)}let Aa=null,wl=null,ld=null,nc=null,Cl=null,cd=null,ic=null,Ve=null,Fe=null,fi={innerFlux:.65,outerFlux:.1,slotFlux:0};const os=12,hd=[-os,-os,-os],ud=[os,os,os];function wM(){return Aa||(Aa=new Worker(new URL(""+new URL("scalarFieldWorker-BIDCwx3E.js",import.meta.url).href,import.meta.url),{type:"module"})),Aa}function sc(i,t){if(Z.isoMode==="lShell"){if(Cl&&cd===i&&ic===t)return Cl}else if(wl&&ld===i&&nc===t)return wl;return null}function rc(){if(De(Z,fe),!Z.showIsosurfaces||!ke)return;ed(),Z._rebuildLevelToggles&&Z._rebuildLevelToggles();const i=Number(Z.isoResolution),t=Z.maxDegree;if(sc(t,i)){so();return}const e=Z.isoMode==="lShell",n=e?"computeLShellGrid":"computeGrid",s=e?"L-shell":"|B|";Ta(!0,`Computing ${s} field...`);const r=wM();r.onmessage=o=>{o.data.type==="progress"?RM(o.data.percent,s):o.data.type==="gridReady"?(wl=o.data.grid,ld=t,nc=o.data.resolution,Ta(!1),so()):o.data.type==="lshellGridReady"&&(Cl=o.data.grid,cd=t,ic=o.data.resolution,Ta(!1),so())},r.postMessage({type:n,coeffs:ke,maxDegree:t,resolution:i,boundsMin:hd,boundsMax:ud})}function so(){const i=Number(Z.isoResolution),t=Z.maxDegree,e=sc(t,i);if(!e||(Ve&&(me.remove(Ve),Nu(Ve),Ve=null),!Z.showIsosurfaces))return;const n=Z.isoMode==="lShell"?ic:nc,s=[];for(const[o,a]of Object.entries(Z.isoLevels)){if(!a)continue;const l=Number(o),{positions:c,normals:h,indices:u}=vv(e,n,hd,ud,l);s.push({level:l,positions:c,normals:h,indices:u})}if(s.length===0)return;const r=xo.getActivePlanes(Z.clipEquatorial,Z.clipMeridional);Ve=Sv(s,{opacity:Z.isoOpacity,clippingPlanes:r,mode:Z.isoMode}),me.add(Ve)}function dd(){if(!Z.showIsosurfaces){Ve&&(me.remove(Ve),Nu(Ve),Ve=null);return}const i=Number(Z.isoResolution),t=Z.maxDegree;sc(t,i)&&so(),Ve&&bv(Ve,Z.isoOpacity),De(Z,fe)}function oc(){!Z.showInnerBelt&&!Z.showOuterBelt||!ke||(md(),De(Z,fe))}function fd(){var t,e,n;const i=new sn;if((t=ke==null?void 0:ke.g)!=null&&t[1]){const s=ke.g[1][0],r=ke.g[1][1],o=((n=(e=ke.h)==null?void 0:e[1])==null?void 0:n[1])??0,a=new O(-r,-s,-o).normalize();i.setFromUnitVectors(new O(0,1,0),a)}return i}function pd(){Qs&&Qs.mesh.quaternion.copy(fd())}function md(){if(Fe&&(me.remove(Fe),Fu(Fe),Fe=null),!Z.showInnerBelt&&!Z.showOuterBelt)return;const i=Z.sunLongitude*Math.PI/180,t=xo.getActivePlanes(Z.clipEquatorial,Z.clipMeridional);Fe=Pv({showInnerBelt:Z.showInnerBelt,showOuterBelt:Z.showOuterBelt,clippingPlanes:t,opacity:Z.beltOpacity,sunDirX:Math.cos(i),sunDirZ:Math.sin(i),stormIntensity:Math.min(1,Math.abs(Z.dst)/150)}),Fe.quaternion.copy(fd()),me.add(Fe),pd()}function CM(){if(!Z.showInnerBelt&&!Z.showOuterBelt){Fe&&(me.remove(Fe),Fu(Fe),Fe=null);return}md(),De(Z,fe)}function gd(){xo.setMeridionalAngle(Z.clipMeridionalAngle);const i=xo.getActivePlanes(Z.clipEquatorial,Z.clipMeridional);Ve&&Ev(Ve,i),Fe&&Iv(Fe,i),Pe&&Pe.traverse(t=>{t.material&&(t.material.clippingPlanes=i,t.material.needsUpdate=!0)}),De(Z,fe)}function Ta(i,t){let e=document.getElementById("iso-loading");!e&&i&&(e=document.createElement("div"),e.id="iso-loading",e.style.cssText="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);color:#fff;font-family:monospace;font-size:14px;background:rgba(0,0,0,0.7);padding:12px 24px;border-radius:8px;z-index:1000;pointer-events:none;",document.body.appendChild(e)),e&&(e.textContent=t||"Computing...",e.style.display=i?"block":"none")}function RM(i,t){const e=document.getElementById("iso-loading");e&&(e.textContent=`Computing ${t} field... ${i}%`)}const $s=120,PM=300,$r=289;let Qn=null,Ki=null,ji=null,Ih=null,Uh=null;const LM=800,DM=i=>i*i*(3-2*i),IM=i=>i*i*i;let Kn=null,Rl=null;function _d(i){Qn=new Date(i),Qn.setUTCHours(0,0,0,0);const t=new Float32Array($r),e=new Float32Array($r*3),n=new Float32Array($r*3);for(let l=0;l<$r;l++){const c=l*PM;t[l]=c;const h=new Date(Qn.getTime()+c*1e3),u=P1(h),d=Math.cos(u.declinationRad);e[l*3]=d*Math.cos(u.longitudeRad)*$s,e[l*3+1]=Math.sin(u.declinationRad)*$s,e[l*3+2]=d*Math.sin(u.longitudeRad)*$s;const p=L1(h),g=Math.cos(p.declinationRad);n[l*3]=g*Math.cos(p.longitudeRad)*p.distanceEarthRadii,n[l*3+1]=Math.sin(p.declinationRad)*p.distanceEarthRadii,n[l*3+2]=g*Math.sin(p.longitudeRad)*p.distanceEarthRadii}Ki==null||Ki.stopAllAction();const s=new ms(".position",t,e),r=new po("sun-day",86400,[s]);Ki=new Hc(qs.group),Ih=Ki.clipAction(r),Ih.play(),ji==null||ji.stopAllAction();const o=new ms(".position",t,n),a=new po("moon-day",86400,[o]);ji=new Hc(Dh.mesh),Uh=ji.clipAction(a),Uh.play(),qs.group.visible=!0,Dh.setVisible(!0)}function vd(i){const t=(i.getTime()-Qn.getTime())/1e3;Ki.setTime(t),qs.group.visible=!0,yM.position.copy(qs.group.position).multiplyScalar(5/$s);const e=qs.group.position;Z.sunLongitude=(Math.atan2(e.z,e.x)*180/Math.PI+360)%360,Z.sunDeclination=Math.asin(e.y/$s)*180/Math.PI,ji.setTime(t)}function Pl(i=!1){const t=new Date(Z.datetimeString);if(isNaN(t.getTime()))return;rd(t);const e=new Date(t);e.setUTCHours(0,0,0,0),(!Qn||e.getTime()!==Qn.getTime())&&_d(t),vd(t),Z.solarWindEnabled&&(Lo(i?8200:1e3,!i),Z.showIsosurfaces&&rc(),(Z.showInnerBelt||Z.showOuterBelt)&&oc(),Z.showMagnetopause&&ac()),Z.satellites.enabled&&he&&(gs=0),De(Z,fe)}function xd(i){yx(i);const t=Wu(i);t&&(t.vSw!==null&&(Z.solarWindSpeed=Math.min(800,Math.max(300,Math.round(t.vSw)))),t.nSw!==null&&(Z.solarWindDensity=Math.min(30,Math.max(1,Math.round(t.nSw*10)/10))),t.By!==null&&(Z.imfBy=Math.min(20,Math.max(-20,Math.round(t.By*10)/10))),t.Bz!==null&&(Z.imfBz=Math.min(20,Math.max(-20,Math.round(t.Bz*10)/10))),t.Dst!==null&&(Z.dst=Math.min(50,Math.max(-200,Math.round(t.Dst)))),t.G1!==null&&(Z.g1=Math.max(0,t.G1)),t.G2!==null&&(Z.g2=Math.max(0,t.G2)),XM())}function UM(i){const t=new Date(i);if(isNaN(t.getTime()))return;Z.datetimeString=i,rd(t),BM(t);const e=new Date(t);e.setUTCHours(0,0,0,0),(!Qn||e.getTime()!==Qn.getTime())&&_d(t),vd(t);const n=Math.floor(t.getTime()/36e5)*3600;n!==Rl&&(Rl=n,xd(n))}function NM(){Lo(1e3),Z.showIsosurfaces&&rc(),(Z.showInnerBelt||Z.showOuterBelt)&&oc(),Z.showMagnetopause&&ac(),De(Z,fe)}let pi=null,Qs=null,Ll=null,Oe=null,he=null,vi=null,Md=0,gs=0,In=-1,yd=0;const wa=new Map,Yr=new Map;let Ca=null;function FM(i,t){const e=`${i}-${String(t).padStart(2,"0")}`;if(wa.has(e))return Promise.resolve(wa.get(e));if(Yr.has(e))return Yr.get(e);const n=fetch(`./data/tles/${e}.json`).then(s=>s.ok?s.json():null).catch(()=>null).then(s=>(wa.set(e,s),Yr.delete(e),s));return Yr.set(e,n),n}function OM(i){if(!(i!=null&&i.tles)||!Oe)return;const t=i.tles;for(const e of Oe.satellites){const n=t[String(e.id)];n&&(e.line1=n[0],e.line2=n[1])}vi&&(vi.postMessage({type:"init",satellites:Oe.satellites}),gs=0)}function BM(i){if(!Z.satellites.enabled||!Oe)return;const t=`${i.getUTCFullYear()}-${String(i.getUTCMonth()+1).padStart(2,"0")}`;t!==Ca&&(Ca=t,FM(i.getUTCFullYear(),i.getUTCMonth()+1).then(e=>{e&&t===Ca&&OM(e)}))}function Sd(i){return(i.getTime()+631152e6)/864e5}function zM(i){return i>=86400?200:i>=3600?500:i>=60?2e3:1e4}function Do(){return vi||(vi=new Worker("/workers/satelliteWorker.js"),vi.onmessage=kM,vi.onerror=i=>console.error("[SatWorker]",i.message)),vi}function kM(i){const{type:t,requestId:e}=i.data;if(t==="ready"){gs=0;return}if(t==="positions"){if(e!==Md)return;he&&(he.updatePositions(i.data.positions,i.data.count),In>=0&&ke&&VM(i.data.positions,i.data.count));return}if(t==="orbit"){if(e!==yd)return;if(he&&i.data.points){const n=Oe==null?void 0:Oe.satellites[In];he.setOrbitTrace(i.data.points,(n==null?void 0:n.orbitClass)??"leo")}return}}function VM(i,t){if(In<0||In>=t)return;const e=i[In*3],n=i[In*3+1],s=i[In*3+2];if(n<-1)return;const r=6371.2,o=e*r,a=n*r,l=s*r,c=Math.sqrt(o*o+a*a+l*l),h=Math.acos(Math.max(-1,Math.min(1,a/c))),u=Math.atan2(l,o),d=Js(),p=ux(c,h,u,ke,Z.maxDegree,d),g=Ou(d),_=Bu(g,(d==null?void 0:d.dst)??0),m=Oe.satellites[In],f=c-r,y=90-h*(180/Math.PI),M=u*(180/Math.PI);px({latDeg:y,lonDeg:M,altitudeKm:f,bMagnitude:p.bMagnitude,lShell:p.lShell,region:p.region,saaProximity:p.saaProximity,kp:g,swEnabled:(d==null?void 0:d.enabled)??!1,innerFlux:_.innerFlux,outerFlux:_.outerFlux,slotFlux:_.slotFlux},m.name)}function HM(){if(!Oe||!he)return;const i=++Md,t=Te?new Date(Te.getSimTimeAt(0)):new Date(Z.datetimeString);Do().postMessage({type:"propagate",requestId:i,ds50utc:Sd(t)})}function Nh(i){if(In=i,he&&he.setSelected(i),i<0){delete Z._satSelected,he&&he.clearOrbitTrace(),Hu(),De(Z,fe);return}Z._satSelected=Oe.satellites[i].id;const t=Oe.satellites[i],e=tc(t.line2);if(e>0){const n=++yd,s=Te?new Date(Te.getSimTimeAt(0)):new Date(Z.datetimeString);Do().postMessage({type:"traceOrbit",requestId:n,satIndex:i,ds50utc:Sd(s),periodMin:e})}De(Z,fe)}function GM(){if(!Oe)return;Z.satellites.enabled?(he||(he=ju(me,Oe.satellites),["leo","meo","geo","heo","other"].filter(t=>Z.satellites[`show${t.charAt(0).toUpperCase()+t.slice(1)}`]),Do().postMessage({type:"init",satellites:Oe.satellites})),he&&he.applyVisibility(Z.satellites),gs=0):(he&&(he.dispose(),he=null),Hu());const i=["leo","meo","geo","heo","other"].filter(t=>Z.satellites[`show${t.charAt(0).toUpperCase()+t.slice(1)}`]);vM(i,Z.satellites.notableOnly),De(Z,fe)}function ac(){pi&&(me.remove(pi),pi.traverse(i=>{i.geometry&&i.geometry.dispose(),i.material&&i.material.dispose()}),pi=null),!(!Z.showMagnetopause||!Z.solarWindEnabled)&&Td(async()=>{const{buildMagnetopauseMesh:i}=await import("./magnetopauseMesh-re55UzHk.js");return{buildMagnetopauseMesh:i}},[],import.meta.url).then(({buildMagnetopauseMesh:i})=>{pi=i(Js()),pi&&me.add(pi)})}function WM(){ac(),De(Z,fe)}hv();let Te;const{refreshSolarWindControls:XM}=cv(Z,{onRebuild:()=>{Lo(1e3),De(Z,fe)},onVisualChange:ad,onIsoRebuild:()=>rc(),onIsoVisualChange:dd,onClipChange:gd,onBeltRebuild:()=>oc(),onBeltVisualChange:CM,onSatelliteSwarmChange:GM,onSatelliteSearchOpen:()=>_M(),onSolarWindChange:NM,onMagnetopauseChange:WM,onParticleChange:()=>De(Z,fe),onAuroraChange:()=>De(Z,fe)});Lh&&(sM(Z,Lh),dd());Te=mv({initialTime:new Date(Z.datetimeString),onTimeChange:i=>UM(i),onPause:()=>{Kn=null,Pl(!1)},onPeriodicRebuild:()=>{Te&&Te.getSpeed()>=3600||Pl(!0)},getSolarWindData:Wu});gx(()=>Te.refreshColors());window.addEventListener("resize",()=>{fe.aspect=window.innerWidth/window.innerHeight,fe.updateProjectionMatrix(),Vn.setSize(window.innerWidth,window.innerHeight)});let Fh=0;function bd(i=performance.now()){requestAnimationFrame(bd);const t=Math.min((i-Fh)/1e3,.1);if(Fh=i,Te&&Te.tick(i),TM(i),Qs&&Qs.update(t,Js(),Z.particles,(Te==null?void 0:Te.getSpeed())??1),Ll&&Ll.update(i/1e3,Z.dst,Z.aurora),Z.satellites.enabled&&he){const e=zM((Te==null?void 0:Te.getSpeed())??1);i-gs>e&&(gs=i,HM()),he.lerpPositions(i),he.tickOrbitTrace(i)}if(Fe&&(Z.showInnerBelt||Z.showOuterBelt)){const e=Js(),n=Ou(e),s=(e==null?void 0:e.dst)??Z.dst,r=Bu(n,s),o=.02;fi.innerFlux+=o*(r.innerFlux-fi.innerFlux),fi.outerFlux+=o*(r.outerFlux-fi.outerFlux),fi.slotFlux+=o*(r.slotFlux-fi.slotFlux),Dv(Fe,fi,Z.beltOpacity)}Po.update(),Vn.render(me,fe)}async function qM(){await Promise.all([SM(),Gu(2025,11)]),fetch("./data/satellites.json").then(t=>t.json()).then(t=>{if(Oe=t,mM(t.satellites,{onSelect:Nh}),Z.satellites.enabled&&(he=ju(me,t.satellites),he.applyVisibility(Z.satellites),Do().postMessage({type:"init",satellites:t.satellites})),rn._satSelected!==void 0){const e=cM(t.satellites,rn._satSelected);e>=0&&(xM(e),Z.satellites.enabled&&Nh(e))}}).catch(t=>console.warn("[Satellites] Failed to load catalog:",t)),Qs=Yx(me),pd(),Ll=eM(me),uv("Solar wind: Qin-Denton/WGhour.d (2026)");const i=Math.floor(new Date(Z.datetimeString).getTime()/1e3);xd(i),Rl=Math.floor(i/3600)*3600,Te.refreshColors(),Pl(),Lo(),ad(),bd()}qM();export{Ee as B,en as D,mo as E,we as F,va as K,vu as M,be as a,ix as b,zu as c,sx as f};
