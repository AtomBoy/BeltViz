...
#define LOW_PRECISION`),t}function q_(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Bh?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Rd?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Dn&&(t="SHADOWMAP_TYPE_VSM"),t}function $_(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case cs:case hs:t="ENVMAP_TYPE_CUBE";break;case So:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Y_(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case hs:t="ENVMAP_MODE_REFRACTION";break}return t}function K_(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case zh:t="ENVMAP_BLENDING_MULTIPLY";break;case Yd:t="ENVMAP_BLENDING_MIX";break;case Kd:t="ENVMAP_BLENDING_ADD";break}return t}function j_(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Z_(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=q_(e),c=$_(e),h=Y_(e),u=K_(e),d=j_(e),p=B_(e),g=z_(r),_=s.createProgram();let m,f,y=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+f);const M=y+m+o,x=y+f+a,w=oh(s,s.VERTEX_SHADER,M),A=oh(s,s.FRAGMENT_SHADER,x);s.attachShader(_,w),s.attachShader(_,A),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function C(E){if(i.debug.checkShaderErrors){const D=s.getProgramInfoLog(_).trim(),L=s.getShaderInfoLog(w).trim(),N=s.getShaderInfoLog(A).trim();let F=!0,I=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(F=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,w,A);else{const G=lh(s,w,"vertex"),z=lh(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
Program Info Log: `+D+`
`+G+`
`+z)}else D!==""?console.warn("THREE.WebGLProgram: Program Info Log:",D):(L===""||N==="")&&(I=!1);I&&(E.diagnostics={runnable:F,programLog:D,vertexShader:{log:L,prefix:m},fragmentShader:{log:N,prefix:f}})}s.deleteShader(w),s.deleteShader(A),P=new no(s,_),S=k_(s,_)}let P;this.getUniforms=function(){return P===void 0&&C(this),P};let S;this.getAttributes=function(){return S===void 0&&C(this),S};let v=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=s.getProgramParameter(_,L_)),v},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(_),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=D_++,this.cacheKey=t,this.usedTimes=1,this.program=_,this.vertexShader=w,this.fragmentShader=A,this}let J_=0;class Q_{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,n=t.fragmentShader,s=this._getShaderStage(e),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(t);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){const e=this.shaderCache;let n=e.get(t);return n===void 0&&(n=new t1(t),e.set(t,n)),n}}class t1{constructor(t){this.id=J_++,this.code=t,this.usedTimes=0}}function e1(i,t,e,n,s,r,o){const a=new iu,l=new Q_,c=new Set,h=[],u=s.logarithmicDepthBuffer,d=s.vertexTextures;let p=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(S){return c.add(S),S===0?"uv":`uv${S}`}function m(S,v,E,D,L){const N=D.fog,F=L.geometry,I=S.isMeshStandardMaterial?D.environment:null,G=(S.isMeshStandardMaterial?e:t).get(S.envMap||I),z=G&&G.mapping===So?G.image.height:null,Q=g[S.type];S.precision!==null&&(p=s.getMaxPrecision(S.precision),p!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",p,"instead."));const X=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,et=X!==void 0?X.length:0;let at=0;F.morphAttributes.position!==void 0&&(at=1),F.morphAttributes.normal!==void 0&&(at=2),F.morphAttributes.color!==void 0&&(at=3);let ft,B,$,nt;if(Q){const Qt=_n[Q];ft=Qt.vertexShader,B=Qt.fragmentShader}else ft=S.vertexShader,B=S.fragmentShader,l.update(S),$=l.getVertexShaderID(S),nt=l.getFragmentShaderID(S);const K=i.getRenderTarget(),ct=i.state.buffers.depth.getReversed(),st=L.isInstancedMesh===!0,ht=L.isBatchedMesh===!0,wt=!!S.map,Tt=!!S.matcap,Nt=!!G,U=!!S.aoMap,Gt=!!S.lightMap,Rt=!!S.bumpMap,Lt=!!S.normalMap,pt=!!S.displacementMap,ut=!!S.emissiveMap,Ct=!!S.metalnessMap,R=!!S.roughnessMap,b=S.anisotropy>0,W=S.clearcoat>0,tt=S.dispersion>0,it=S.iridescence>0,j=S.sheen>0,vt=S.transmission>0,dt=b&&!!S.anisotropyMap,gt=W&&!!S.clearcoatMap,zt=W&&!!S.clearcoatNormalMap,lt=W&&!!S.clearcoatRoughnessMap,St=it&&!!S.iridescenceMap,Dt=it&&!!S.iridescenceThicknessMap,Ut=j&&!!S.sheenColorMap,_t=j&&!!S.sheenRoughnessMap,Wt=!!S.specularMap,Vt=!!S.specularColorMap,Zt=!!S.specularIntensityMap,V=vt&&!!S.transmissionMap,xt=vt&&!!S.thicknessMap,Z=!!S.gradientMap,ot=!!S.alphaMap,At=S.alphaTest>0,bt=!!S.alphaHash,Ht=!!S.extensions;let le=Qn;S.toneMapped&&(K===null||K.isXRRenderTarget===!0)&&(le=i.toneMapping);const ye={shaderID:Q,shaderType:S.type,shaderName:S.name,vertexShader:ft,fragmentShader:B,defines:S.defines,customVertexShaderID:$,customFragmentShaderID:nt,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:p,batching:ht,batchingColor:ht&&L._colorsTexture!==null,instancing:st,instancingColor:st&&L.instanceColor!==null,instancingMorph:st&&L.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:K===null?i.outputColorSpace:K.isXRRenderTarget===!0?K.texture.colorSpace:fs,alphaToCoverage:!!S.alphaToCoverage,map:wt,matcap:Tt,envMap:Nt,envMapMode:Nt&&G.mapping,envMapCubeUVHeight:z,aoMap:U,lightMap:Gt,bumpMap:Rt,normalMap:Lt,displacementMap:d&&pt,emissiveMap:ut,normalMapObjectSpace:Lt&&S.normalMapType===hf,normalMapTangentSpace:Lt&&S.normalMapType===Jh,metalnessMap:Ct,roughnessMap:R,anisotropy:b,anisotropyMap:dt,clearcoat:W,clearcoatMap:gt,clearcoatNormalMap:zt,clearcoatRoughnessMap:lt,dispersion:tt,iridescence:it,iridescenceMap:St,iridescenceThicknessMap:Dt,sheen:j,sheenColorMap:Ut,sheenRoughnessMap:_t,specularMap:Wt,specularColorMap:Vt,specularIntensityMap:Zt,transmission:vt,transmissionMap:V,thicknessMap:xt,gradientMap:Z,opaque:S.transparent===!1&&S.blending===is&&S.alphaToCoverage===!1,alphaMap:ot,alphaTest:At,alphaHash:bt,combine:S.combine,mapUv:wt&&_(S.map.channel),aoMapUv:U&&_(S.aoMap.channel),lightMapUv:Gt&&_(S.lightMap.channel),bumpMapUv:Rt&&_(S.bumpMap.channel),normalMapUv:Lt&&_(S.normalMap.channel),displacementMapUv:pt&&_(S.displacementMap.channel),emissiveMapUv:ut&&_(S.emissiveMap.channel),metalnessMapUv:Ct&&_(S.metalnessMap.channel),roughnessMapUv:R&&_(S.roughnessMap.channel),anisotropyMapUv:dt&&_(S.anisotropyMap.channel),clearcoatMapUv:gt&&_(S.clearcoatMap.channel),clearcoatNormalMapUv:zt&&_(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:lt&&_(S.clearcoatRoughnessMap.channel),iridescenceMapUv:St&&_(S.iridescenceMap.channel),iridescenceThicknessMapUv:Dt&&_(S.iridescenceThicknessMap.channel),sheenColorMapUv:Ut&&_(S.sheenColorMap.channel),sheenRoughnessMapUv:_t&&_(S.sheenRoughnessMap.channel),specularMapUv:Wt&&_(S.specularMap.channel),specularColorMapUv:Vt&&_(S.specularColorMap.channel),specularIntensityMapUv:Zt&&_(S.specularIntensityMap.channel),transmissionMapUv:V&&_(S.transmissionMap.channel),thicknessMapUv:xt&&_(S.thicknessMap.channel),alphaMapUv:ot&&_(S.alphaMap.channel),vertexTangents:!!F.attributes.tangent&&(Lt||b),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,pointsUvs:L.isPoints===!0&&!!F.attributes.uv&&(wt||ot),fog:!!N,useFog:S.fog===!0,fogExp2:!!N&&N.isFogExp2,flatShading:S.flatShading===!0,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:ct,skinning:L.isSkinnedMesh===!0,morphTargets:F.morphAttributes.position!==void 0,morphNormals:F.morphAttributes.normal!==void 0,morphColors:F.morphAttributes.color!==void 0,morphTargetsCount:et,morphTextureStride:at,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:S.dithering,shadowMapEnabled:i.shadowMap.enabled&&E.length>0,shadowMapType:i.shadowMap.type,toneMapping:le,decodeVideoTexture:wt&&S.map.isVideoTexture===!0&&Jt.getTransfer(S.map.colorSpace)===se,decodeVideoTextureEmissive:ut&&S.emissiveMap.isVideoTexture===!0&&Jt.getTransfer(S.emissiveMap.colorSpace)===se,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===en,flipSided:S.side===He,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:Ht&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ht&&S.extensions.multiDraw===!0||ht)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return ye.vertexUv1s=c.has(1),ye.vertexUv2s=c.has(2),ye.vertexUv3s=c.has(3),c.clear(),ye}function f(S){const v=[];if(S.shaderID?v.push(S.shaderID):(v.push(S.customVertexShaderID),v.push(S.customFragmentShaderID)),S.defines!==void 0)for(const E in S.defines)v.push(E),v.push(S.defines[E]);return S.isRawShaderMaterial===!1&&(y(v,S),M(v,S),v.push(i.outputColorSpace)),v.push(S.customProgramCacheKey),v.join()}function y(S,v){S.push(v.precision),S.push(v.outputColorSpace),S.push(v.envMapMode),S.push(v.envMapCubeUVHeight),S.push(v.mapUv),S.push(v.alphaMapUv),S.push(v.lightMapUv),S.push(v.aoMapUv),S.push(v.bumpMapUv),S.push(v.normalMapUv),S.push(v.displacementMapUv),S.push(v.emissiveMapUv),S.push(v.metalnessMapUv),S.push(v.roughnessMapUv),S.push(v.anisotropyMapUv),S.push(v.clearcoatMapUv),S.push(v.clearcoatNormalMapUv),S.push(v.clearcoatRoughnessMapUv),S.push(v.iridescenceMapUv),S.push(v.iridescenceThicknessMapUv),S.push(v.sheenColorMapUv),S.push(v.sheenRoughnessMapUv),S.push(v.specularMapUv),S.push(v.specularColorMapUv),S.push(v.specularIntensityMapUv),S.push(v.transmissionMapUv),S.push(v.thicknessMapUv),S.push(v.combine),S.push(v.fogExp2),S.push(v.sizeAttenuation),S.push(v.morphTargetsCount),S.push(v.morphAttributeCount),S.push(v.numDirLights),S.push(v.numPointLights),S.push(v.numSpotLights),S.push(v.numSpotLightMaps),S.push(v.numHemiLights),S.push(v.numRectAreaLights),S.push(v.numDirLightShadows),S.push(v.numPointLightShadows),S.push(v.numSpotLightShadows),S.push(v.numSpotLightShadowsWithMaps),S.push(v.numLightProbes),S.push(v.shadowMapType),S.push(v.toneMapping),S.push(v.numClippingPlanes),S.push(v.numClipIntersection),S.push(v.depthPacking)}function M(S,v){a.disableAll(),v.supportsVertexTextures&&a.enable(0),v.instancing&&a.enable(1),v.instancingColor&&a.enable(2),v.instancingMorph&&a.enable(3),v.matcap&&a.enable(4),v.envMap&&a.enable(5),v.normalMapObjectSpace&&a.enable(6),v.normalMapTangentSpace&&a.enable(7),v.clearcoat&&a.enable(8),v.iridescence&&a.enable(9),v.alphaTest&&a.enable(10),v.vertexColors&&a.enable(11),v.vertexAlphas&&a.enable(12),v.vertexUv1s&&a.enable(13),v.vertexUv2s&&a.enable(14),v.vertexUv3s&&a.enable(15),v.vertexTangents&&a.enable(16),v.anisotropy&&a.enable(17),v.alphaHash&&a.enable(18),v.batching&&a.enable(19),v.dispersion&&a.enable(20),v.batchingColor&&a.enable(21),S.push(a.mask),a.disableAll(),v.fog&&a.enable(0),v.useFog&&a.enable(1),v.flatShading&&a.enable(2),v.logarithmicDepthBuffer&&a.enable(3),v.reverseDepthBuffer&&a.enable(4),v.skinning&&a.enable(5),v.morphTargets&&a.enable(6),v.morphNormals&&a.enable(7),v.morphColors&&a.enable(8),v.premultipliedAlpha&&a.enable(9),v.shadowMapEnabled&&a.enable(10),v.doubleSided&&a.enable(11),v.flipSided&&a.enable(12),v.useDepthPacking&&a.enable(13),v.dithering&&a.enable(14),v.transmission&&a.enable(15),v.sheen&&a.enable(16),v.opaque&&a.enable(17),v.pointsUvs&&a.enable(18),v.decodeVideoTexture&&a.enable(19),v.decodeVideoTextureEmissive&&a.enable(20),v.alphaToCoverage&&a.enable(21),S.push(a.mask)}function x(S){const v=g[S.type];let E;if(v){const D=_n[v];E=Vf.clone(D.uniforms)}else E=S.uniforms;return E}function w(S,v){let E;for(let D=0,L=h.length;D<L;D++){const N=h[D];if(N.cacheKey===v){E=N,++E.usedTimes;break}}return E===void 0&&(E=new Z_(i,v,S,r),h.push(E)),E}function A(S){if(--S.usedTimes===0){const v=h.indexOf(S);h[v]=h[h.length-1],h.pop(),S.destroy()}}function C(S){l.remove(S)}function P(){l.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:x,acquireProgram:w,releaseProgram:A,releaseShaderCache:C,programs:h,dispose:P}}function n1(){let i=new WeakMap;function t(o){return i.has(o)}function e(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function s(o,a,l){i.get(o)[a]=l}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function i1(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.z!==t.z?i.z-t.z:i.id-t.id}function fh(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function ph(){const i=[];let t=0;const e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function o(u,d,p,g,_,m){let f=i[t];return f===void 0?(f={id:u.id,object:u,geometry:d,material:p,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},i[t]=f):(f.id=u.id,f.object=u,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=u.renderOrder,f.z=_,f.group=m),t++,f}function a(u,d,p,g,_,m){const f=o(u,d,p,g,_,m);p.transmission>0?n.push(f):p.transparent===!0?s.push(f):e.push(f)}function l(u,d,p,g,_,m){const f=o(u,d,p,g,_,m);p.transmission>0?n.unshift(f):p.transparent===!0?s.unshift(f):e.unshift(f)}function c(u,d){e.length>1&&e.sort(u||i1),n.length>1&&n.sort(d||fh),s.length>1&&s.sort(d||fh)}function h(){for(let u=t,d=i.length;u<d;u++){const p=i[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:a,unshift:l,finish:h,sort:c}}function s1(){let i=new WeakMap;function t(n,s){const r=i.get(n);let o;return r===void 0?(o=new ph,i.set(n,[o])):s>=r.length?(o=new ph,r.push(o)):o=r[s],o}function e(){i=new WeakMap}return{get:t,dispose:e}}function r1(){const i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new O,color:new Ot};break;case"SpotLight":e={position:new O,direction:new O,color:new Ot,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new O,color:new Ot,distance:0,decay:0};break;case"HemisphereLight":e={direction:new O,skyColor:new Ot,groundColor:new Ot};break;case"RectAreaLight":e={color:new Ot,position:new O,halfWidth:new O,halfHeight:new O};break}return i[t.id]=e,e}}}function o1(){const i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Pt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Pt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Pt,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}let a1=0;function l1(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function c1(i){const t=new r1,e=o1(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new O);const s=new O,r=new ae,o=new ae;function a(c){let h=0,u=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let p=0,g=0,_=0,m=0,f=0,y=0,M=0,x=0,w=0,A=0,C=0;c.sort(l1);for(let S=0,v=c.length;S<v;S++){const E=c[S],D=E.color,L=E.intensity,N=E.distance,F=E.shadow&&E.shadow.map?E.shadow.map.texture:null;if(E.isAmbientLight)h+=D.r*L,u+=D.g*L,d+=D.b*L;else if(E.isLightProbe){for(let I=0;I<9;I++)n.probe[I].addScaledVector(E.sh.coefficients[I],L);C++}else if(E.isDirectionalLight){const I=t.get(E);if(I.color.copy(E.color).multiplyScalar(E.intensity),E.castShadow){const G=E.shadow,z=e.get(E);z.shadowIntensity=G.intensity,z.shadowBias=G.bias,z.shadowNormalBias=G.normalBias,z.shadowRadius=G.radius,z.shadowMapSize=G.mapSize,n.directionalShadow[p]=z,n.directionalShadowMap[p]=F,n.directionalShadowMatrix[p]=E.shadow.matrix,y++}n.directional[p]=I,p++}else if(E.isSpotLight){const I=t.get(E);I.position.setFromMatrixPosition(E.matrixWorld),I.color.copy(D).multiplyScalar(L),I.distance=N,I.coneCos=Math.cos(E.angle),I.penumbraCos=Math.cos(E.angle*(1-E.penumbra)),I.decay=E.decay,n.spot[_]=I;const G=E.shadow;if(E.map&&(n.spotLightMap[w]=E.map,w++,G.updateMatrices(E),E.castShadow&&A++),n.spotLightMatrix[_]=G.matrix,E.castShadow){const z=e.get(E);z.shadowIntensity=G.intensity,z.shadowBias=G.bias,z.shadowNormalBias=G.normalBias,z.shadowRadius=G.radius,z.shadowMapSize=G.mapSize,n.spotShadow[_]=z,n.spotShadowMap[_]=F,x++}_++}else if(E.isRectAreaLight){const I=t.get(E);I.color.copy(D).multiplyScalar(L),I.halfWidth.set(E.width*.5,0,0),I.halfHeight.set(0,E.height*.5,0),n.rectArea[m]=I,m++}else if(E.isPointLight){const I=t.get(E);if(I.color.copy(E.color).multiplyScalar(E.intensity),I.distance=E.distance,I.decay=E.decay,E.castShadow){const G=E.shadow,z=e.get(E);z.shadowIntensity=G.intensity,z.shadowBias=G.bias,z.shadowNormalBias=G.normalBias,z.shadowRadius=G.radius,z.shadowMapSize=G.mapSize,z.shadowCameraNear=G.camera.near,z.shadowCameraFar=G.camera.far,n.pointShadow[g]=z,n.pointShadowMap[g]=F,n.pointShadowMatrix[g]=E.shadow.matrix,M++}n.point[g]=I,g++}else if(E.isHemisphereLight){const I=t.get(E);I.skyColor.copy(E.color).multiplyScalar(L),I.groundColor.copy(E.groundColor).multiplyScalar(L),n.hemi[f]=I,f++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=yt.LTC_FLOAT_1,n.rectAreaLTC2=yt.LTC_FLOAT_2):(n.rectAreaLTC1=yt.LTC_HALF_1,n.rectAreaLTC2=yt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;const P=n.hash;(P.directionalLength!==p||P.pointLength!==g||P.spotLength!==_||P.rectAreaLength!==m||P.hemiLength!==f||P.numDirectionalShadows!==y||P.numPointShadows!==M||P.numSpotShadows!==x||P.numSpotMaps!==w||P.numLightProbes!==C)&&(n.directional.length=p,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=f,n.directionalShadow.length=y,n.directionalShadowMap.length=y,n.pointShadow.length=M,n.pointShadowMap.length=M,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=y,n.pointShadowMatrix.length=M,n.spotLightMatrix.length=x+w-A,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=C,P.directionalLength=p,P.pointLength=g,P.spotLength=_,P.rectAreaLength=m,P.hemiLength=f,P.numDirectionalShadows=y,P.numPointShadows=M,P.numSpotShadows=x,P.numSpotMaps=w,P.numLightProbes=C,n.version=a1++)}function l(c,h){let u=0,d=0,p=0,g=0,_=0;const m=h.matrixWorldInverse;for(let f=0,y=c.length;f<y;f++){const M=c[f];if(M.isDirectionalLight){const x=n.directional[u];x.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),x.direction.sub(s),x.direction.transformDirection(m),u++}else if(M.isSpotLight){const x=n.spot[p];x.position.setFromMatrixPosition(M.matrixWorld),x.position.applyMatrix4(m),x.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),x.direction.sub(s),x.direction.transformDirection(m),p++}else if(M.isRectAreaLight){const x=n.rectArea[g];x.position.setFromMatrixPosition(M.matrixWorld),x.position.applyMatrix4(m),o.identity(),r.copy(M.matrixWorld),r.premultiply(m),o.extractRotation(r),x.halfWidth.set(M.width*.5,0,0),x.halfHeight.set(0,M.height*.5,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),g++}else if(M.isPointLight){const x=n.point[d];x.position.setFromMatrixPosition(M.matrixWorld),x.position.applyMatrix4(m),d++}else if(M.isHemisphereLight){const x=n.hemi[_];x.direction.setFromMatrixPosition(M.matrixWorld),x.direction.transformDirection(m),_++}}}return{setup:a,setupView:l,state:n}}function mh(i){const t=new c1(i),e=[],n=[];function s(h){c.camera=h,e.length=0,n.length=0}function r(h){e.push(h)}function o(h){n.push(h)}function a(){t.setup(e)}function l(h){t.setupView(e,h)}const c={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:a,setupLightsView:l,pushLight:r,pushShadow:o}}function h1(i){let t=new WeakMap;function e(s,r=0){const o=t.get(s);let a;return o===void 0?(a=new mh(i),t.set(s,[a])):r>=o.length?(a=new mh(i),o.push(a)):a=o[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}const u1=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function f1(i,t,e){let n=new Gl;const s=new Pt,r=new Pt,o=new ue,a=new fp({depthPacking:cf}),l=new pp,c={},h=e.maxTextureSize,u={[zn]:He,[He]:zn,[en]:en},d=new on({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pt},radius:{value:4}},vertexShader:u1,fragmentShader:d1}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new Ae;g.setAttribute("position",new de(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Ee(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Bh;let f=this.type;this.render=function(A,C,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const S=i.getRenderTarget(),v=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),D=i.state;D.setBlending(Jn),D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const L=f!==Dn&&this.type===Dn,N=f===Dn&&this.type!==Dn;for(let F=0,I=A.length;F<I;F++){const G=A[F],z=G.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",G,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const Q=z.getFrameExtents();if(s.multiply(Q),r.copy(z.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/Q.x),s.x=r.x*Q.x,z.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/Q.y),s.y=r.y*Q.y,z.mapSize.y=r.y)),z.map===null||L===!0||N===!0){const et=this.type!==Dn?{minFilter:mn,magFilter:mn}:{};z.map!==null&&z.map.dispose(),z.map=new bi(s.x,s.y,et),z.map.texture.name=G.name+".shadowMap",z.camera.updateProjectionMatrix()}i.setRenderTarget(z.map),i.clear();const X=z.getViewportCount();for(let et=0;et<X;et++){const at=z.getViewport(et);o.set(r.x*at.x,r.y*at.y,r.x*at.z,r.y*at.w),D.viewport(o),z.updateMatrices(G,et),n=z.getFrustum(),x(C,P,z.camera,G,this.type)}z.isPointLightShadow!==!0&&this.type===Dn&&y(z,P),z.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(S,v,E)};function y(A,C){const P=t.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new bi(s.x,s.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(C,null,P,d,_,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(C,null,P,p,_,null)}function M(A,C,P,S){let v=null;const E=P.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(E!==void 0)v=E;else if(v=P.isPointLight===!0?l:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const D=v.uuid,L=C.uuid;let N=c[D];N===void 0&&(N={},c[D]=N);let F=N[L];F===void 0&&(F=v.clone(),N[L]=F,C.addEventListener("dispose",w)),v=F}if(v.visible=C.visible,v.wireframe=C.wireframe,S===Dn?v.side=C.shadowSide!==null?C.shadowSide:C.side:v.side=C.shadowSide!==null?C.shadowSide:u[C.side],v.alphaMap=C.alphaMap,v.alphaTest=C.alphaTest,v.map=C.map,v.clipShadows=C.clipShadows,v.clippingPlanes=C.clippingPlanes,v.clipIntersection=C.clipIntersection,v.displacementMap=C.displacementMap,v.displacementScale=C.displacementScale,v.displacementBias=C.displacementBias,v.wireframeLinewidth=C.wireframeLinewidth,v.linewidth=C.linewidth,P.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const D=i.properties.get(v);D.light=P}return v}function x(A,C,P,S,v){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&v===Dn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,A.matrixWorld);const L=t.update(A),N=A.material;if(Array.isArray(N)){const F=L.groups;for(let I=0,G=F.length;I<G;I++){const z=F[I],Q=N[z.materialIndex];if(Q&&Q.visible){const X=M(A,Q,S,v);A.onBeforeShadow(i,A,C,P,L,X,z),i.renderBufferDirect(P,null,L,X,A,z),A.onAfterShadow(i,A,C,P,L,X,z)}}}else if(N.visible){const F=M(A,N,S,v);A.onBeforeShadow(i,A,C,P,L,F,null),i.renderBufferDirect(P,null,L,F,A,null),A.onAfterShadow(i,A,C,P,L,F,null)}}const D=A.children;for(let L=0,N=D.length;L<N;L++)x(D[L],C,P,S,v)}function w(A){A.target.removeEventListener("dispose",w);for(const P in c){const S=c[P],v=A.target.uuid;v in S&&(S[v].dispose(),delete S[v])}}}const p1={[Da]:Ia,[Ua]:Oa,[Na]:Ba,[ls]:Fa,[Ia]:Da,[Oa]:Ua,[Ba]:Na,[Fa]:ls};function m1(i,t){function e(){let V=!1;const xt=new ue;let Z=null;const ot=new ue(0,0,0,0);return{setMask:function(At){Z!==At&&!V&&(i.colorMask(At,At,At,At),Z=At)},setLocked:function(At){V=At},setClear:function(At,bt,Ht,le,ye){ye===!0&&(At*=le,bt*=le,Ht*=le),xt.set(At,bt,Ht,le),ot.equals(xt)===!1&&(i.clearColor(At,bt,Ht,le),ot.copy(xt))},reset:function(){V=!1,Z=null,ot.set(-1,0,0,0)}}}function n(){let V=!1,xt=!1,Z=null,ot=null,At=null;return{setReversed:function(bt){if(xt!==bt){const Ht=t.get("EXT_clip_control");xt?Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.ZERO_TO_ONE_EXT):Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.NEGATIVE_ONE_TO_ONE_EXT);const le=At;At=null,this.setClear(le)}xt=bt},getReversed:function(){return xt},setTest:function(bt){bt?K(i.DEPTH_TEST):ct(i.DEPTH_TEST)},setMask:function(bt){Z!==bt&&!V&&(i.depthMask(bt),Z=bt)},setFunc:function(bt){if(xt&&(bt=p1[bt]),ot!==bt){switch(bt){case Da:i.depthFunc(i.NEVER);break;case Ia:i.depthFunc(i.ALWAYS);break;case Ua:i.depthFunc(i.LESS);break;case ls:i.depthFunc(i.LEQUAL);break;case Na:i.depthFunc(i.EQUAL);break;case Fa:i.depthFunc(i.GEQUAL);break;case Oa:i.depthFunc(i.GREATER);break;case Ba:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ot=bt}},setLocked:function(bt){V=bt},setClear:function(bt){At!==bt&&(xt&&(bt=1-bt),i.clearDepth(bt),At=bt)},reset:function(){V=!1,Z=null,ot=null,At=null,xt=!1}}}function s(){let V=!1,xt=null,Z=null,ot=null,At=null,bt=null,Ht=null,le=null,ye=null;return{setTest:function(Qt){V||(Qt?K(i.STENCIL_TEST):ct(i.STENCIL_TEST))},setMask:function(Qt){xt!==Qt&&!V&&(i.stencilMask(Qt),xt=Qt)},setFunc:function(Qt,Ge,an){(Z!==Qt||ot!==Ge||At!==an)&&(i.stencilFunc(Qt,Ge,an),Z=Qt,ot=Ge,At=an)},setOp:function(Qt,Ge,an){(bt!==Qt||Ht!==Ge||le!==an)&&(i.stencilOp(Qt,Ge,an),bt=Qt,Ht=Ge,le=an)},setLocked:function(Qt){V=Qt},setClear:function(Qt){ye!==Qt&&(i.clearStencil(Qt),ye=Qt)},reset:function(){V=!1,xt=null,Z=null,ot=null,At=null,bt=null,Ht=null,le=null,ye=null}}}const r=new e,o=new n,a=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,y=null,M=null,x=null,w=null,A=null,C=new Ot(0,0,0),P=0,S=!1,v=null,E=null,D=null,L=null,N=null;const F=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,G=0;const z=i.getParameter(i.VERSION);z.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(z)[1]),I=G>=1):z.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),I=G>=2);let Q=null,X={};const et=i.getParameter(i.SCISSOR_BOX),at=i.getParameter(i.VIEWPORT),ft=new ue().fromArray(et),B=new ue().fromArray(at);function $(V,xt,Z,ot){const At=new Uint8Array(4),bt=i.createTexture();i.bindTexture(V,bt),i.texParameteri(V,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(V,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ht=0;Ht<Z;Ht++)V===i.TEXTURE_3D||V===i.TEXTURE_2D_ARRAY?i.texImage3D(xt,0,i.RGBA,1,1,ot,0,i.RGBA,i.UNSIGNED_BYTE,At):i.texImage2D(xt+Ht,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,At);return bt}const nt={};nt[i.TEXTURE_2D]=$(i.TEXTURE_2D,i.TEXTURE_2D,1),nt[i.TEXTURE_CUBE_MAP]=$(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),nt[i.TEXTURE_2D_ARRAY]=$(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),nt[i.TEXTURE_3D]=$(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),K(i.DEPTH_TEST),o.setFunc(ls),Rt(!1),Lt(hc),K(i.CULL_FACE),U(Jn);function K(V){h[V]!==!0&&(i.enable(V),h[V]=!0)}function ct(V){h[V]!==!1&&(i.disable(V),h[V]=!1)}function st(V,xt){return u[V]!==xt?(i.bindFramebuffer(V,xt),u[V]=xt,V===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=xt),V===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=xt),!0):!1}function ht(V,xt){let Z=p,ot=!1;if(V){Z=d.get(xt),Z===void 0&&(Z=[],d.set(xt,Z));const At=V.textures;if(Z.length!==At.length||Z[0]!==i.COLOR_ATTACHMENT0){for(let bt=0,Ht=At.length;bt<Ht;bt++)Z[bt]=i.COLOR_ATTACHMENT0+bt;Z.length=At.length,ot=!0}}else Z[0]!==i.BACK&&(Z[0]=i.BACK,ot=!0);ot&&i.drawBuffers(Z)}function wt(V){return g!==V?(i.useProgram(V),g=V,!0):!1}const Tt={[_i]:i.FUNC_ADD,[Ld]:i.FUNC_SUBTRACT,[Dd]:i.FUNC_REVERSE_SUBTRACT};Tt[Id]=i.MIN,Tt[Ud]=i.MAX;const Nt={[Nd]:i.ZERO,[Fd]:i.ONE,[Od]:i.SRC_COLOR,[Pa]:i.SRC_ALPHA,[Gd]:i.SRC_ALPHA_SATURATE,[Vd]:i.DST_COLOR,[zd]:i.DST_ALPHA,[Bd]:i.ONE_MINUS_SRC_COLOR,[La]:i.ONE_MINUS_SRC_ALPHA,[Hd]:i.ONE_MINUS_DST_COLOR,[kd]:i.ONE_MINUS_DST_ALPHA,[Wd]:i.CONSTANT_COLOR,[Xd]:i.ONE_MINUS_CONSTANT_COLOR,[qd]:i.CONSTANT_ALPHA,[$d]:i.ONE_MINUS_CONSTANT_ALPHA};function U(V,xt,Z,ot,At,bt,Ht,le,ye,Qt){if(V===Jn){_===!0&&(ct(i.BLEND),_=!1);return}if(_===!1&&(K(i.BLEND),_=!0),V!==Pd){if(V!==m||Qt!==S){if((f!==_i||x!==_i)&&(i.blendEquation(i.FUNC_ADD),f=_i,x=_i),Qt)switch(V){case is:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ei:i.blendFunc(i.ONE,i.ONE);break;case uc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case dc:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}else switch(V){case is:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ei:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case uc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case dc:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}y=null,M=null,w=null,A=null,C.set(0,0,0),P=0,m=V,S=Qt}return}At=At||xt,bt=bt||Z,Ht=Ht||ot,(xt!==f||At!==x)&&(i.blendEquationSeparate(Tt[xt],Tt[At]),f=xt,x=At),(Z!==y||ot!==M||bt!==w||Ht!==A)&&(i.blendFuncSeparate(Nt[Z],Nt[ot],Nt[bt],Nt[Ht]),y=Z,M=ot,w=bt,A=Ht),(le.equals(C)===!1||ye!==P)&&(i.blendColor(le.r,le.g,le.b,ye),C.copy(le),P=ye),m=V,S=!1}function Gt(V,xt){V.side===en?ct(i.CULL_FACE):K(i.CULL_FACE);let Z=V.side===He;xt&&(Z=!Z),Rt(Z),V.blending===is&&V.transparent===!1?U(Jn):U(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),o.setFunc(V.depthFunc),o.setTest(V.depthTest),o.setMask(V.depthWrite),r.setMask(V.colorWrite);const ot=V.stencilWrite;a.setTest(ot),ot&&(a.setMask(V.stencilWriteMask),a.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),a.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),ut(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?K(i.SAMPLE_ALPHA_TO_COVERAGE):ct(i.SAMPLE_ALPHA_TO_COVERAGE)}function Rt(V){v!==V&&(V?i.frontFace(i.CW):i.frontFace(i.CCW),v=V)}function Lt(V){V!==wd?(K(i.CULL_FACE),V!==E&&(V===hc?i.cullFace(i.BACK):V===Cd?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ct(i.CULL_FACE),E=V}function pt(V){V!==D&&(I&&i.lineWidth(V),D=V)}function ut(V,xt,Z){V?(K(i.POLYGON_OFFSET_FILL),(L!==xt||N!==Z)&&(i.polygonOffset(xt,Z),L=xt,N=Z)):ct(i.POLYGON_OFFSET_FILL)}function Ct(V){V?K(i.SCISSOR_TEST):ct(i.SCISSOR_TEST)}function R(V){V===void 0&&(V=i.TEXTURE0+F-1),Q!==V&&(i.activeTexture(V),Q=V)}function b(V,xt,Z){Z===void 0&&(Q===null?Z=i.TEXTURE0+F-1:Z=Q);let ot=X[Z];ot===void 0&&(ot={type:void 0,texture:void 0},X[Z]=ot),(ot.type!==V||ot.texture!==xt)&&(Q!==Z&&(i.activeTexture(Z),Q=Z),i.bindTexture(V,xt||nt[V]),ot.type=V,ot.texture=xt)}function W(){const V=X[Q];V!==void 0&&V.type!==void 0&&(i.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function tt(){try{i.compressedTexImage2D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function it(){try{i.compressedTexImage3D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function j(){try{i.texSubImage2D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function vt(){try{i.texSubImage3D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function dt(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function gt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function zt(){try{i.texStorage2D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function lt(){try{i.texStorage3D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function St(){try{i.texImage2D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Dt(){try{i.texImage3D.apply(i,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Ut(V){ft.equals(V)===!1&&(i.scissor(V.x,V.y,V.z,V.w),ft.copy(V))}function _t(V){B.equals(V)===!1&&(i.viewport(V.x,V.y,V.z,V.w),B.copy(V))}function Wt(V,xt){let Z=c.get(xt);Z===void 0&&(Z=new WeakMap,c.set(xt,Z));let ot=Z.get(V);ot===void 0&&(ot=i.getUniformBlockIndex(xt,V.name),Z.set(V,ot))}function Vt(V,xt){const ot=c.get(xt).get(V);l.get(xt)!==ot&&(i.uniformBlockBinding(xt,ot,V.__bindingPointIndex),l.set(xt,ot))}function Zt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},Q=null,X={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,y=null,M=null,x=null,w=null,A=null,C=new Ot(0,0,0),P=0,S=!1,v=null,E=null,D=null,L=null,N=null,ft.set(0,0,i.canvas.width,i.canvas.height),B.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:K,disable:ct,bindFramebuffer:st,drawBuffers:ht,useProgram:wt,setBlending:U,setMaterial:Gt,setFlipSided:Rt,setCullFace:Lt,setLineWidth:pt,setPolygonOffset:ut,setScissorTest:Ct,activeTexture:R,bindTexture:b,unbindTexture:W,compressedTexImage2D:tt,compressedTexImage3D:it,texImage2D:St,texImage3D:Dt,updateUBOMapping:Wt,uniformBlockBinding:Vt,texStorage2D:zt,texStorage3D:lt,texSubImage2D:j,texSubImage3D:vt,compressedTexSubImage2D:dt,compressedTexSubImage3D:gt,scissor:Ut,viewport:_t,reset:Zt}}function g1(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Pt,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(R,b){return p?new OffscreenCanvas(R,b):js("canvas")}function _(R,b,W){let tt=1;const it=Ct(R);if((it.width>W||it.height>W)&&(tt=W/Math.max(it.width,it.height)),tt<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const j=Math.floor(tt*it.width),vt=Math.floor(tt*it.height);u===void 0&&(u=g(j,vt));const dt=b?g(j,vt):u;return dt.width=j,dt.height=vt,dt.getContext("2d").drawImage(R,0,0,j,vt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+it.width+"x"+it.height+") to ("+j+"x"+vt+")."),dt}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+it.width+"x"+it.height+")."),R;return R}function m(R){return R.generateMipmaps}function f(R){i.generateMipmap(R)}function y(R){return R.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?i.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(R,b,W,tt,it=!1){if(R!==null){if(i[R]!==void 0)return i[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let j=b;if(b===i.RED&&(W===i.FLOAT&&(j=i.R32F),W===i.HALF_FLOAT&&(j=i.R16F),W===i.UNSIGNED_BYTE&&(j=i.R8)),b===i.RED_INTEGER&&(W===i.UNSIGNED_BYTE&&(j=i.R8UI),W===i.UNSIGNED_SHORT&&(j=i.R16UI),W===i.UNSIGNED_INT&&(j=i.R32UI),W===i.BYTE&&(j=i.R8I),W===i.SHORT&&(j=i.R16I),W===i.INT&&(j=i.R32I)),b===i.RG&&(W===i.FLOAT&&(j=i.RG32F),W===i.HALF_FLOAT&&(j=i.RG16F),W===i.UNSIGNED_BYTE&&(j=i.RG8)),b===i.RG_INTEGER&&(W===i.UNSIGNED_BYTE&&(j=i.RG8UI),W===i.UNSIGNED_SHORT&&(j=i.RG16UI),W===i.UNSIGNED_INT&&(j=i.RG32UI),W===i.BYTE&&(j=i.RG8I),W===i.SHORT&&(j=i.RG16I),W===i.INT&&(j=i.RG32I)),b===i.RGB_INTEGER&&(W===i.UNSIGNED_BYTE&&(j=i.RGB8UI),W===i.UNSIGNED_SHORT&&(j=i.RGB16UI),W===i.UNSIGNED_INT&&(j=i.RGB32UI),W===i.BYTE&&(j=i.RGB8I),W===i.SHORT&&(j=i.RGB16I),W===i.INT&&(j=i.RGB32I)),b===i.RGBA_INTEGER&&(W===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),W===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),W===i.UNSIGNED_INT&&(j=i.RGBA32UI),W===i.BYTE&&(j=i.RGBA8I),W===i.SHORT&&(j=i.RGBA16I),W===i.INT&&(j=i.RGBA32I)),b===i.RGB&&W===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),b===i.RGBA){const vt=it?lo:Jt.getTransfer(tt);W===i.FLOAT&&(j=i.RGBA32F),W===i.HALF_FLOAT&&(j=i.RGBA16F),W===i.UNSIGNED_BYTE&&(j=vt===se?i.SRGB8_ALPHA8:i.RGBA8),W===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),W===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function x(R,b){let W;return R?b===null||b===Si||b===us?W=i.DEPTH24_STENCIL8:b===Nn?W=i.DEPTH32F_STENCIL8:b===Ks&&(W=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Si||b===us?W=i.DEPTH_COMPONENT24:b===Nn?W=i.DEPTH_COMPONENT32F:b===Ks&&(W=i.DEPTH_COMPONENT16),W}function w(R,b){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==mn&&R.minFilter!==Mn?Math.log2(Math.max(b.width,b.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?b.mipmaps.length:1}function A(R){const b=R.target;b.removeEventListener("dispose",A),P(b),b.isVideoTexture&&h.delete(b)}function C(R){const b=R.target;b.removeEventListener("dispose",C),v(b)}function P(R){const b=n.get(R);if(b.__webglInit===void 0)return;const W=R.source,tt=d.get(W);if(tt){const it=tt[b.__cacheKey];it.usedTimes--,it.usedTimes===0&&S(R),Object.keys(tt).length===0&&d.delete(W)}n.remove(R)}function S(R){const b=n.get(R);i.deleteTexture(b.__webglTexture);const W=R.source,tt=d.get(W);delete tt[b.__cacheKey],o.memory.textures--}function v(R){const b=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let tt=0;tt<6;tt++){if(Array.isArray(b.__webglFramebuffer[tt]))for(let it=0;it<b.__webglFramebuffer[tt].length;it++)i.deleteFramebuffer(b.__webglFramebuffer[tt][it]);else i.deleteFramebuffer(b.__webglFramebuffer[tt]);b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer[tt])}else{if(Array.isArray(b.__webglFramebuffer))for(let tt=0;tt<b.__webglFramebuffer.length;tt++)i.deleteFramebuffer(b.__webglFramebuffer[tt]);else i.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&i.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let tt=0;tt<b.__webglColorRenderbuffer.length;tt++)b.__webglColorRenderbuffer[tt]&&i.deleteRenderbuffer(b.__webglColorRenderbuffer[tt]);b.__webglDepthRenderbuffer&&i.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const W=R.textures;for(let tt=0,it=W.length;tt<it;tt++){const j=n.get(W[tt]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),o.memory.textures--),n.remove(W[tt])}n.remove(R)}let E=0;function D(){E=0}function L(){const R=E;return R>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+s.maxTextures),E+=1,R}function N(R){const b=[];return b.push(R.wrapS),b.push(R.wrapT),b.push(R.wrapR||0),b.push(R.magFilter),b.push(R.minFilter),b.push(R.anisotropy),b.push(R.internalFormat),b.push(R.format),b.push(R.type),b.push(R.generateMipmaps),b.push(R.premultiplyAlpha),b.push(R.flipY),b.push(R.unpackAlignment),b.push(R.colorSpace),b.join()}function F(R,b){const W=n.get(R);if(R.isVideoTexture&&pt(R),R.isRenderTargetTexture===!1&&R.version>0&&W.__version!==R.version){const tt=R.image;if(tt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(tt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{B(W,R,b);return}}e.bindTexture(i.TEXTURE_2D,W.__webglTexture,i.TEXTURE0+b)}function I(R,b){const W=n.get(R);if(R.version>0&&W.__version!==R.version){B(W,R,b);return}e.bindTexture(i.TEXTURE_2D_ARRAY,W.__webglTexture,i.TEXTURE0+b)}function G(R,b){const W=n.get(R);if(R.version>0&&W.__version!==R.version){B(W,R,b);return}e.bindTexture(i.TEXTURE_3D,W.__webglTexture,i.TEXTURE0+b)}function z(R,b){const W=n.get(R);if(R.version>0&&W.__version!==R.version){$(W,R,b);return}e.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture,i.TEXTURE0+b)}const Q={[Va]:i.REPEAT,[xi]:i.CLAMP_TO_EDGE,[Ha]:i.MIRRORED_REPEAT},X={[mn]:i.NEAREST,[nf]:i.NEAREST_MIPMAP_NEAREST,[ur]:i.NEAREST_MIPMAP_LINEAR,[Mn]:i.LINEAR,[Fo]:i.LINEAR_MIPMAP_NEAREST,[Mi]:i.LINEAR_MIPMAP_LINEAR},et={[uf]:i.NEVER,[_f]:i.ALWAYS,[df]:i.LESS,[Qh]:i.LEQUAL,[ff]:i.EQUAL,[gf]:i.GEQUAL,[pf]:i.GREATER,[mf]:i.NOTEQUAL};function at(R,b){if(b.type===Nn&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===Mn||b.magFilter===Fo||b.magFilter===ur||b.magFilter===Mi||b.minFilter===Mn||b.minFilter===Fo||b.minFilter===ur||b.minFilter===Mi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(R,i.TEXTURE_WRAP_S,Q[b.wrapS]),i.texParameteri(R,i.TEXTURE_WRAP_T,Q[b.wrapT]),(R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY)&&i.texParameteri(R,i.TEXTURE_WRAP_R,Q[b.wrapR]),i.texParameteri(R,i.TEXTURE_MAG_FILTER,X[b.magFilter]),i.texParameteri(R,i.TEXTURE_MIN_FILTER,X[b.minFilter]),b.compareFunction&&(i.texParameteri(R,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(R,i.TEXTURE_COMPARE_FUNC,et[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===mn||b.minFilter!==ur&&b.minFilter!==Mi||b.type===Nn&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const W=t.get("EXT_texture_filter_anisotropic");i.texParameterf(R,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function ft(R,b){let W=!1;R.__webglInit===void 0&&(R.__webglInit=!0,b.addEventListener("dispose",A));const tt=b.source;let it=d.get(tt);it===void 0&&(it={},d.set(tt,it));const j=N(b);if(j!==R.__cacheKey){it[j]===void 0&&(it[j]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,W=!0),it[j].usedTimes++;const vt=it[R.__cacheKey];vt!==void 0&&(it[R.__cacheKey].usedTimes--,vt.usedTimes===0&&S(b)),R.__cacheKey=j,R.__webglTexture=it[j].texture}return W}function B(R,b,W){let tt=i.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(tt=i.TEXTURE_2D_ARRAY),b.isData3DTexture&&(tt=i.TEXTURE_3D);const it=ft(R,b),j=b.source;e.bindTexture(tt,R.__webglTexture,i.TEXTURE0+W);const vt=n.get(j);if(j.version!==vt.__version||it===!0){e.activeTexture(i.TEXTURE0+W);const dt=Jt.getPrimaries(Jt.workingColorSpace),gt=b.colorSpace===Kn?null:Jt.getPrimaries(b.colorSpace),zt=b.colorSpace===Kn||dt===gt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,zt);let lt=_(b.image,!1,s.maxTextureSize);lt=ut(b,lt);const St=r.convert(b.format,b.colorSpace),Dt=r.convert(b.type);let Ut=M(b.internalFormat,St,Dt,b.colorSpace,b.isVideoTexture);at(tt,b);let _t;const Wt=b.mipmaps,Vt=b.isVideoTexture!==!0,Zt=vt.__version===void 0||it===!0,V=j.dataReady,xt=w(b,lt);if(b.isDepthTexture)Ut=x(b.format===ds,b.type),Zt&&(Vt?e.texStorage2D(i.TEXTURE_2D,1,Ut,lt.width,lt.height):e.texImage2D(i.TEXTURE_2D,0,Ut,lt.width,lt.height,0,St,Dt,null));else if(b.isDataTexture)if(Wt.length>0){Vt&&Zt&&e.texStorage2D(i.TEXTURE_2D,xt,Ut,Wt[0].width,Wt[0].height);for(let Z=0,ot=Wt.length;Z<ot;Z++)_t=Wt[Z],Vt?V&&e.texSubImage2D(i.TEXTURE_2D,Z,0,0,_t.width,_t.height,St,Dt,_t.data):e.texImage2D(i.TEXTURE_2D,Z,Ut,_t.width,_t.height,0,St,Dt,_t.data);b.generateMipmaps=!1}else Vt?(Zt&&e.texStorage2D(i.TEXTURE_2D,xt,Ut,lt.width,lt.height),V&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,lt.width,lt.height,St,Dt,lt.data)):e.texImage2D(i.TEXTURE_2D,0,Ut,lt.width,lt.height,0,St,Dt,lt.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){Vt&&Zt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,xt,Ut,Wt[0].width,Wt[0].height,lt.depth);for(let Z=0,ot=Wt.length;Z<ot;Z++)if(_t=Wt[Z],b.format!==pn)if(St!==null)if(Vt){if(V)if(b.layerUpdates.size>0){const At=Xc(_t.width,_t.height,b.format,b.type);for(const bt of b.layerUpdates){const Ht=_t.data.subarray(bt*At/_t.data.BYTES_PER_ELEMENT,(bt+1)*At/_t.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,bt,_t.width,_t.height,1,St,Ht)}b.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,_t.width,_t.height,lt.depth,St,_t.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Z,Ut,_t.width,_t.height,lt.depth,0,_t.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Vt?V&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,_t.width,_t.height,lt.depth,St,Dt,_t.data):e.texImage3D(i.TEXTURE_2D_ARRAY,Z,Ut,_t.width,_t.height,lt.depth,0,St,Dt,_t.data)}else{Vt&&Zt&&e.texStorage2D(i.TEXTURE_2D,xt,Ut,Wt[0].width,Wt[0].height);for(let Z=0,ot=Wt.length;Z<ot;Z++)_t=Wt[Z],b.format!==pn?St!==null?Vt?V&&e.compressedTexSubImage2D(i.TEXTURE_2D,Z,0,0,_t.width,_t.height,St,_t.data):e.compressedTexImage2D(i.TEXTURE_2D,Z,Ut,_t.width,_t.height,0,_t.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Vt?V&&e.texSubImage2D(i.TEXTURE_2D,Z,0,0,_t.width,_t.height,St,Dt,_t.data):e.texImage2D(i.TEXTURE_2D,Z,Ut,_t.width,_t.height,0,St,Dt,_t.data)}else if(b.isDataArrayTexture)if(Vt){if(Zt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,xt,Ut,lt.width,lt.height,lt.depth),V)if(b.layerUpdates.size>0){const Z=Xc(lt.width,lt.height,b.format,b.type);for(const ot of b.layerUpdates){const At=lt.data.subarray(ot*Z/lt.data.BYTES_PER_ELEMENT,(ot+1)*Z/lt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ot,lt.width,lt.height,1,St,Dt,At)}b.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,lt.width,lt.height,lt.depth,St,Dt,lt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Ut,lt.width,lt.height,lt.depth,0,St,Dt,lt.data);else if(b.isData3DTexture)Vt?(Zt&&e.texStorage3D(i.TEXTURE_3D,xt,Ut,lt.width,lt.height,lt.depth),V&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,lt.width,lt.height,lt.depth,St,Dt,lt.data)):e.texImage3D(i.TEXTURE_3D,0,Ut,lt.width,lt.height,lt.depth,0,St,Dt,lt.data);else if(b.isFramebufferTexture){if(Zt)if(Vt)e.texStorage2D(i.TEXTURE_2D,xt,Ut,lt.width,lt.height);else{let Z=lt.width,ot=lt.height;for(let At=0;At<xt;At++)e.texImage2D(i.TEXTURE_2D,At,Ut,Z,ot,0,St,Dt,null),Z>>=1,ot>>=1}}else if(Wt.length>0){if(Vt&&Zt){const Z=Ct(Wt[0]);e.texStorage2D(i.TEXTURE_2D,xt,Ut,Z.width,Z.height)}for(let Z=0,ot=Wt.length;Z<ot;Z++)_t=Wt[Z],Vt?V&&e.texSubImage2D(i.TEXTURE_2D,Z,0,0,St,Dt,_t):e.texImage2D(i.TEXTURE_2D,Z,Ut,St,Dt,_t);b.generateMipmaps=!1}else if(Vt){if(Zt){const Z=Ct(lt);e.texStorage2D(i.TEXTURE_2D,xt,Ut,Z.width,Z.height)}V&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,St,Dt,lt)}else e.texImage2D(i.TEXTURE_2D,0,Ut,St,Dt,lt);m(b)&&f(tt),vt.__version=j.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function $(R,b,W){if(b.image.length!==6)return;const tt=ft(R,b),it=b.source;e.bindTexture(i.TEXTURE_CUBE_MAP,R.__webglTexture,i.TEXTURE0+W);const j=n.get(it);if(it.version!==j.__version||tt===!0){e.activeTexture(i.TEXTURE0+W);const vt=Jt.getPrimaries(Jt.workingColorSpace),dt=b.colorSpace===Kn?null:Jt.getPrimaries(b.colorSpace),gt=b.colorSpace===Kn||vt===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,gt);const zt=b.isCompressedTexture||b.image[0].isCompressedTexture,lt=b.image[0]&&b.image[0].isDataTexture,St=[];for(let ot=0;ot<6;ot++)!zt&&!lt?St[ot]=_(b.image[ot],!0,s.maxCubemapSize):St[ot]=lt?b.image[ot].image:b.image[ot],St[ot]=ut(b,St[ot]);const Dt=St[0],Ut=r.convert(b.format,b.colorSpace),_t=r.convert(b.type),Wt=M(b.internalFormat,Ut,_t,b.colorSpace),Vt=b.isVideoTexture!==!0,Zt=j.__version===void 0||tt===!0,V=it.dataReady;let xt=w(b,Dt);at(i.TEXTURE_CUBE_MAP,b);let Z;if(zt){Vt&&Zt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,xt,Wt,Dt.width,Dt.height);for(let ot=0;ot<6;ot++){Z=St[ot].mipmaps;for(let At=0;At<Z.length;At++){const bt=Z[At];b.format!==pn?Ut!==null?Vt?V&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At,0,0,bt.width,bt.height,Ut,bt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At,Wt,bt.width,bt.height,0,bt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Vt?V&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At,0,0,bt.width,bt.height,Ut,_t,bt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At,Wt,bt.width,bt.height,0,Ut,_t,bt.data)}}}else{if(Z=b.mipmaps,Vt&&Zt){Z.length>0&&xt++;const ot=Ct(St[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,xt,Wt,ot.width,ot.height)}for(let ot=0;ot<6;ot++)if(lt){Vt?V&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,0,0,St[ot].width,St[ot].height,Ut,_t,St[ot].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,Wt,St[ot].width,St[ot].height,0,Ut,_t,St[ot].data);for(let At=0;At<Z.length;At++){const Ht=Z[At].image[ot].image;Vt?V&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At+1,0,0,Ht.width,Ht.height,Ut,_t,Ht.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At+1,Wt,Ht.width,Ht.height,0,Ut,_t,Ht.data)}}else{Vt?V&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,0,0,Ut,_t,St[ot]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,Wt,Ut,_t,St[ot]);for(let At=0;At<Z.length;At++){const bt=Z[At];Vt?V&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At+1,0,0,Ut,_t,bt.image[ot]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,At+1,Wt,Ut,_t,bt.image[ot])}}}m(b)&&f(i.TEXTURE_CUBE_MAP),j.__version=it.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function nt(R,b,W,tt,it,j){const vt=r.convert(W.format,W.colorSpace),dt=r.convert(W.type),gt=M(W.internalFormat,vt,dt,W.colorSpace),zt=n.get(b),lt=n.get(W);if(lt.__renderTarget=b,!zt.__hasExternalTextures){const St=Math.max(1,b.width>>j),Dt=Math.max(1,b.height>>j);it===i.TEXTURE_3D||it===i.TEXTURE_2D_ARRAY?e.texImage3D(it,j,gt,St,Dt,b.depth,0,vt,dt,null):e.texImage2D(it,j,gt,St,Dt,0,vt,dt,null)}e.bindFramebuffer(i.FRAMEBUFFER,R),Lt(b)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,tt,it,lt.__webglTexture,0,Rt(b)):(it===i.TEXTURE_2D||it>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&it<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,tt,it,lt.__webglTexture,j),e.bindFramebuffer(i.FRAMEBUFFER,null)}function K(R,b,W){if(i.bindRenderbuffer(i.RENDERBUFFER,R),b.depthBuffer){const tt=b.depthTexture,it=tt&&tt.isDepthTexture?tt.type:null,j=x(b.stencilBuffer,it),vt=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,dt=Rt(b);Lt(b)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,dt,j,b.width,b.height):W?i.renderbufferStorageMultisample(i.RENDERBUFFER,dt,j,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,j,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,vt,i.RENDERBUFFER,R)}else{const tt=b.textures;for(let it=0;it<tt.length;it++){const j=tt[it],vt=r.convert(j.format,j.colorSpace),dt=r.convert(j.type),gt=M(j.internalFormat,vt,dt,j.colorSpace),zt=Rt(b);W&&Lt(b)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,zt,gt,b.width,b.height):Lt(b)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,zt,gt,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,gt,b.width,b.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ct(R,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,R),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const tt=n.get(b.depthTexture);tt.__renderTarget=b,(!tt.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),F(b.depthTexture,0);const it=tt.__webglTexture,j=Rt(b);if(b.depthTexture.format===ss)Lt(b)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,it,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,it,0);else if(b.depthTexture.format===ds)Lt(b)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,it,0,j):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,it,0);else throw new Error("Unknown depthTexture format")}function st(R){const b=n.get(R),W=R.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==R.depthTexture){const tt=R.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),tt){const it=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,tt.removeEventListener("dispose",it)};tt.addEventListener("dispose",it),b.__depthDisposeCallback=it}b.__boundDepthTexture=tt}if(R.depthTexture&&!b.__autoAllocateDepthBuffer){if(W)throw new Error("target.depthTexture not supported in Cube render targets");ct(b.__webglFramebuffer,R)}else if(W){b.__webglDepthbuffer=[];for(let tt=0;tt<6;tt++)if(e.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[tt]),b.__webglDepthbuffer[tt]===void 0)b.__webglDepthbuffer[tt]=i.createRenderbuffer(),K(b.__webglDepthbuffer[tt],R,!1);else{const it=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,j=b.__webglDepthbuffer[tt];i.bindRenderbuffer(i.RENDERBUFFER,j),i.framebufferRenderbuffer(i.FRAMEBUFFER,it,i.RENDERBUFFER,j)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=i.createRenderbuffer(),K(b.__webglDepthbuffer,R,!1);else{const tt=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,it=b.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,it),i.framebufferRenderbuffer(i.FRAMEBUFFER,tt,i.RENDERBUFFER,it)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function ht(R,b,W){const tt=n.get(R);b!==void 0&&nt(tt.__webglFramebuffer,R,R.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),W!==void 0&&st(R)}function wt(R){const b=R.texture,W=n.get(R),tt=n.get(b);R.addEventListener("dispose",C);const it=R.textures,j=R.isWebGLCubeRenderTarget===!0,vt=it.length>1;if(vt||(tt.__webglTexture===void 0&&(tt.__webglTexture=i.createTexture()),tt.__version=b.version,o.memory.textures++),j){W.__webglFramebuffer=[];for(let dt=0;dt<6;dt++)if(b.mipmaps&&b.mipmaps.length>0){W.__webglFramebuffer[dt]=[];for(let gt=0;gt<b.mipmaps.length;gt++)W.__webglFramebuffer[dt][gt]=i.createFramebuffer()}else W.__webglFramebuffer[dt]=i.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){W.__webglFramebuffer=[];for(let dt=0;dt<b.mipmaps.length;dt++)W.__webglFramebuffer[dt]=i.createFramebuffer()}else W.__webglFramebuffer=i.createFramebuffer();if(vt)for(let dt=0,gt=it.length;dt<gt;dt++){const zt=n.get(it[dt]);zt.__webglTexture===void 0&&(zt.__webglTexture=i.createTexture(),o.memory.textures++)}if(R.samples>0&&Lt(R)===!1){W.__webglMultisampledFramebuffer=i.createFramebuffer(),W.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let dt=0;dt<it.length;dt++){const gt=it[dt];W.__webglColorRenderbuffer[dt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,W.__webglColorRenderbuffer[dt]);const zt=r.convert(gt.format,gt.colorSpace),lt=r.convert(gt.type),St=M(gt.internalFormat,zt,lt,gt.colorSpace,R.isXRRenderTarget===!0),Dt=Rt(R);i.renderbufferStorageMultisample(i.RENDERBUFFER,Dt,St,R.width,R.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,W.__webglColorRenderbuffer[dt])}i.bindRenderbuffer(i.RENDERBUFFER,null),R.depthBuffer&&(W.__webglDepthRenderbuffer=i.createRenderbuffer(),K(W.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){e.bindTexture(i.TEXTURE_CUBE_MAP,tt.__webglTexture),at(i.TEXTURE_CUBE_MAP,b);for(let dt=0;dt<6;dt++)if(b.mipmaps&&b.mipmaps.length>0)for(let gt=0;gt<b.mipmaps.length;gt++)nt(W.__webglFramebuffer[dt][gt],R,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,gt);else nt(W.__webglFramebuffer[dt],R,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0);m(b)&&f(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(vt){for(let dt=0,gt=it.length;dt<gt;dt++){const zt=it[dt],lt=n.get(zt);e.bindTexture(i.TEXTURE_2D,lt.__webglTexture),at(i.TEXTURE_2D,zt),nt(W.__webglFramebuffer,R,zt,i.COLOR_ATTACHMENT0+dt,i.TEXTURE_2D,0),m(zt)&&f(i.TEXTURE_2D)}e.unbindTexture()}else{let dt=i.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(dt=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(dt,tt.__webglTexture),at(dt,b),b.mipmaps&&b.mipmaps.length>0)for(let gt=0;gt<b.mipmaps.length;gt++)nt(W.__webglFramebuffer[gt],R,b,i.COLOR_ATTACHMENT0,dt,gt);else nt(W.__webglFramebuffer,R,b,i.COLOR_ATTACHMENT0,dt,0);m(b)&&f(dt),e.unbindTexture()}R.depthBuffer&&st(R)}function Tt(R){const b=R.textures;for(let W=0,tt=b.length;W<tt;W++){const it=b[W];if(m(it)){const j=y(R),vt=n.get(it).__webglTexture;e.bindTexture(j,vt),f(j),e.unbindTexture()}}}const Nt=[],U=[];function Gt(R){if(R.samples>0){if(Lt(R)===!1){const b=R.textures,W=R.width,tt=R.height;let it=i.COLOR_BUFFER_BIT;const j=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,vt=n.get(R),dt=b.length>1;if(dt)for(let gt=0;gt<b.length;gt++)e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,vt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,vt.__webglFramebuffer);for(let gt=0;gt<b.length;gt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(it|=i.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(it|=i.STENCIL_BUFFER_BIT)),dt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,vt.__webglColorRenderbuffer[gt]);const zt=n.get(b[gt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,zt,0)}i.blitFramebuffer(0,0,W,tt,0,0,W,tt,it,i.NEAREST),l===!0&&(Nt.length=0,U.length=0,Nt.push(i.COLOR_ATTACHMENT0+gt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(Nt.push(j),U.push(j),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,U)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Nt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),dt)for(let gt=0;gt<b.length;gt++){e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.RENDERBUFFER,vt.__webglColorRenderbuffer[gt]);const zt=n.get(b[gt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.TEXTURE_2D,zt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,vt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const b=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[b])}}}function Rt(R){return Math.min(s.maxSamples,R.samples)}function Lt(R){const b=n.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function pt(R){const b=o.render.frame;h.get(R)!==b&&(h.set(R,b),R.update())}function ut(R,b){const W=R.colorSpace,tt=R.format,it=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||W!==fs&&W!==Kn&&(Jt.getTransfer(W)===se?(tt!==pn||it!==kn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",W)),b}function Ct(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=L,this.resetTextureUnits=D,this.setTexture2D=F,this.setTexture2DArray=I,this.setTexture3D=G,this.setTextureCube=z,this.rebindTextures=ht,this.setupRenderTarget=wt,this.updateRenderTargetMipmap=Tt,this.updateMultisampleRenderTarget=Gt,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=nt,this.useMultisampledRTT=Lt}function _1(i,t){function e(n,s=Kn){let r;const o=Jt.getTransfer(s);if(n===kn)return i.UNSIGNED_BYTE;if(n===Nl)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Fl)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Wh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Hh)return i.BYTE;if(n===Gh)return i.SHORT;if(n===Ks)return i.UNSIGNED_SHORT;if(n===Ul)return i.INT;if(n===Si)return i.UNSIGNED_INT;if(n===Nn)return i.FLOAT;if(n===tr)return i.HALF_FLOAT;if(n===Xh)return i.ALPHA;if(n===qh)return i.RGB;if(n===pn)return i.RGBA;if(n===$h)return i.LUMINANCE;if(n===Yh)return i.LUMINANCE_ALPHA;if(n===ss)return i.DEPTH_COMPONENT;if(n===ds)return i.DEPTH_STENCIL;if(n===Kh)return i.RED;if(n===Ol)return i.RED_INTEGER;if(n===jh)return i.RG;if(n===Bl)return i.RG_INTEGER;if(n===zl)return i.RGBA_INTEGER;if(n===jr||n===Zr||n===Jr||n===Qr)if(o===se)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===jr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Zr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Jr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Qr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===jr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Zr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Jr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Qr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ga||n===Wa||n===Xa||n===qa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Ga)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Wa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Xa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===qa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===$a||n===Ya||n===Ka)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===$a||n===Ya)return o===se?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Ka)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ja||n===Za||n===Ja||n===Qa||n===tl||n===el||n===nl||n===il||n===sl||n===rl||n===ol||n===al||n===ll||n===cl)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ja)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Za)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ja)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Qa)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===tl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===el)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===nl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===il)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===sl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===rl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ol)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===al)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ll)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===cl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===to||n===hl||n===ul)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===to)return o===se?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===hl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ul)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Zh||n===dl||n===fl||n===pl)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===to)return r.COMPRESSED_RED_RGTC1_EXT;if(n===dl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===fl)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===pl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===us?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const v1={type:"move"};class _a{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new yn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new yn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new yn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),f=this._getHandJoint(c,_);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),p=.02,g=.005;c.inputState.pinching&&d>p+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=p-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(v1)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new yn;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const x1=`
void main() {
...
}`;class y1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const s=new Le,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new on({vertexShader:x1,fragmentShader:M1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Ee(new Eo(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class S1 extends ni{constructor(t,e){super();const n=this;let s=null,r=1,o=null,a="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,g=null;const _=new y1,m=e.getContextAttributes();let f=null,y=null;const M=[],x=[],w=new Pt;let A=null;const C=new tn;C.viewport=new ue;const P=new tn;P.viewport=new ue;const S=[C,P],v=new Pp;let E=null,D=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(B){let $=M[B];return $===void 0&&($=new _a,M[B]=$),$.getTargetRaySpace()},this.getControllerGrip=function(B){let $=M[B];return $===void 0&&($=new _a,M[B]=$),$.getGripSpace()},this.getHand=function(B){let $=M[B];return $===void 0&&($=new _a,M[B]=$),$.getHandSpace()};function L(B){const $=x.indexOf(B.inputSource);if($===-1)return;const nt=M[$];nt!==void 0&&(nt.update(B.inputSource,B.frame,c||o),nt.dispatchEvent({type:B.type,data:B.inputSource}))}function N(){s.removeEventListener("select",L),s.removeEventListener("selectstart",L),s.removeEventListener("selectend",L),s.removeEventListener("squeeze",L),s.removeEventListener("squeezestart",L),s.removeEventListener("squeezeend",L),s.removeEventListener("end",N),s.removeEventListener("inputsourceschange",F);for(let B=0;B<M.length;B++){const $=x[B];$!==null&&(x[B]=null,M[B].disconnect($))}E=null,D=null,_.reset(),t.setRenderTarget(f),p=null,d=null,u=null,s=null,y=null,ft.stop(),n.isPresenting=!1,t.setPixelRatio(A),t.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(B){r=B,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(B){a=B,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(B){c=B},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(B){if(s=B,s!==null){if(f=t.getRenderTarget(),s.addEventListener("select",L),s.addEventListener("selectstart",L),s.addEventListener("selectend",L),s.addEventListener("squeeze",L),s.addEventListener("squeezestart",L),s.addEventListener("squeezeend",L),s.addEventListener("end",N),s.addEventListener("inputsourceschange",F),m.xrCompatible!==!0&&await e.makeXRCompatible(),A=t.getPixelRatio(),t.getSize(w),s.enabledFeatures!==void 0&&s.enabledFeatures.includes("layers")){let nt=null,K=null,ct=null;m.depth&&(ct=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,nt=m.stencil?ds:ss,K=m.stencil?us:Si);const st={colorFormat:e.RGBA8,depthFormat:ct,scaleFactor:r};u=new XRWebGLBinding(s,e),d=u.createProjectionLayer(st),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),y=new bi(d.textureWidth,d.textureHeight,{format:pn,type:kn,depthTexture:new mu(d.textureWidth,d.textureHeight,K,void 0,void 0,void 0,void 0,void 0,void 0,nt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}else{const nt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,nt),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new bi(p.framebufferWidth,p.framebufferHeight,{format:pn,type:kn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),ft.setContext(s),ft.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function F(B){for(let $=0;$<B.removed.length;$++){const nt=B.removed[$],K=x.indexOf(nt);K>=0&&(x[K]=null,M[K].disconnect(nt))}for(let $=0;$<B.added.length;$++){const nt=B.added[$];let K=x.indexOf(nt);if(K===-1){for(let st=0;st<M.length;st++)if(st>=x.length){x.push(nt),K=st;break}else if(x[st]===null){x[st]=nt,K=st;break}if(K===-1)break}const ct=M[K];ct&&ct.connect(nt)}}const I=new O,G=new O;function z(B,$,nt){I.setFromMatrixPosition($.matrixWorld),G.setFromMatrixPosition(nt.matrixWorld);const K=I.distanceTo(G),ct=$.projectionMatrix.elements,st=nt.projectionMatrix.elements,ht=ct[14]/(ct[10]-1),wt=ct[14]/(ct[10]+1),Tt=(ct[9]+1)/ct[5],Nt=(ct[9]-1)/ct[5],U=(ct[8]-1)/ct[0],Gt=(st[8]+1)/st[0],Rt=ht*U,Lt=ht*Gt,pt=K/(-U+Gt),ut=pt*-U;if($.matrixWorld.decompose(B.position,B.quaternion,B.scale),B.translateX(ut),B.translateZ(pt),B.matrixWorld.compose(B.position,B.quaternion,B.scale),B.matrixWorldInverse.copy(B.matrixWorld).invert(),ct[10]===-1)B.projectionMatrix.copy($.projectionMatrix),B.projectionMatrixInverse.copy($.projectionMatrixInverse);else{const Ct=ht+pt,R=wt+pt,b=Rt-ut,W=Lt+(K-ut),tt=Tt*wt/R*Ct,it=Nt*wt/R*Ct;B.projectionMatrix.makePerspective(b,W,tt,it,Ct,R),B.projectionMatrixInverse.copy(B.projectionMatrix).invert()}}function Q(B,$){$===null?B.matrixWorld.copy(B.matrix):B.matrixWorld.multiplyMatrices($.matrixWorld,B.matrix),B.matrixWorldInverse.copy(B.matrixWorld).invert()}this.updateCamera=function(B){if(s===null)return;let $=B.near,nt=B.far;_.texture!==null&&(_.depthNear>0&&($=_.depthNear),_.depthFar>0&&(nt=_.depthFar)),v.near=P.near=C.near=$,v.far=P.far=C.far=nt,(E!==v.near||D!==v.far)&&(s.updateRenderState({depthNear:v.near,depthFar:v.far}),E=v.near,D=v.far),C.layers.mask=B.layers.mask|2,P.layers.mask=B.layers.mask|4,v.layers.mask=C.layers.mask|P.layers.mask;const K=B.parent,ct=v.cameras;Q(v,K);for(let st=0;st<ct.length;st++)Q(ct[st],K);ct.length===2?z(v,C,P):v.projectionMatrix.copy(C.projectionMatrix),X(B,v,K)};function X(B,$,nt){nt===null?B.matrix.copy($.matrixWorld):(B.matrix.copy(nt.matrixWorld),B.matrix.invert(),B.matrix.multiply($.matrixWorld)),B.matrix.decompose(B.position,B.quaternion,B.scale),B.updateMatrixWorld(!0),B.projectionMatrix.copy($.projectionMatrix),B.projectionMatrixInverse.copy($.projectionMatrixInverse),B.isPerspectiveCamera&&(B.fov=_l*2*Math.atan(1/B.projectionMatrix.elements[5]),B.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(B){l=B,d!==null&&(d.fixedFoveation=B),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=B)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(v)};let et=null;function at(B,$){if(h=$.getViewerPose(c||o),g=$,h!==null){const nt=h.views;p!==null&&(t.setRenderTargetFramebuffer(y,p.framebuffer),t.setRenderTarget(y));let K=!1;nt.length!==v.cameras.length&&(v.cameras.length=0,K=!0);for(let st=0;st<nt.length;st++){const ht=nt[st];let wt=null;if(p!==null)wt=p.getViewport(ht);else{const Nt=u.getViewSubImage(d,ht);wt=Nt.viewport,st===0&&(t.setRenderTargetTextures(y,Nt.colorTexture,d.ignoreDepthValues?void 0:Nt.depthStencilTexture),t.setRenderTarget(y))}let Tt=S[st];Tt===void 0&&(Tt=new tn,Tt.layers.enable(st),Tt.viewport=new ue,S[st]=Tt),Tt.matrix.fromArray(ht.transform.matrix),Tt.matrix.decompose(Tt.position,Tt.quaternion,Tt.scale),Tt.projectionMatrix.fromArray(ht.projectionMatrix),Tt.projectionMatrixInverse.copy(Tt.projectionMatrix).invert(),Tt.viewport.set(wt.x,wt.y,wt.width,wt.height),st===0&&(v.matrix.copy(Tt.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),K===!0&&v.cameras.push(Tt)}const ct=s.enabledFeatures;if(ct&&ct.includes("depth-sensing")){const st=u.getDepthInformation(nt[0]);st&&st.isValid&&st.texture&&_.init(t,st,s.renderState)}}for(let nt=0;nt<M.length;nt++){const K=x[nt],ct=M[nt];K!==null&&ct!==void 0&&ct.update(K,$,c||o)}et&&et(B,$),$.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:$}),g=null}const ft=new Au;ft.setAnimationLoop(at),this.setAnimationLoop=function(B){et=B},this.dispose=function(){}}}const hi=new En,b1=new ae;function E1(i,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,au(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,y,M,x){f.isMeshBasicMaterial||f.isMeshLambertMaterial?r(m,f):f.isMeshToonMaterial?(r(m,f),u(m,f)):f.isMeshPhongMaterial?(r(m,f),h(m,f)):f.isMeshStandardMaterial?(r(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,x)):f.isMeshMatcapMaterial?(r(m,f),g(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),_(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(o(m,f),f.isLineDashedMaterial&&a(m,f)):f.isPointsMaterial?l(m,f,y,M):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===He&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===He&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const y=t.get(f),M=y.envMap,x=y.envMapRotation;M&&(m.envMap.value=M,hi.copy(x),hi.x*=-1,hi.y*=-1,hi.z*=-1,M.isCubeTexture&&M.isRenderTargetTexture===!1&&(hi.y*=-1,hi.z*=-1),m.envMapRotation.value.setFromMatrix4(b1.makeRotationFromEuler(hi)),m.flipEnvMap.value=M.isCubeTexture&&M.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function o(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function a(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,y,M){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*y,m.scale.value=M*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function u(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,y){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===He&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function _(m,f){const y=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function A1(i,t,e,n){let s={},r={},o=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,M){const x=M.program;n.uniformBlockBinding(y,x)}function c(y,M){let x=s[y.id];x===void 0&&(g(y),x=h(y),s[y.id]=x,y.addEventListener("dispose",m));const w=M.program;n.updateUBOMapping(y,w);const A=t.render.frame;r[y.id]!==A&&(d(y),r[y.id]=A)}function h(y){const M=u();y.__bindingPointIndex=M;const x=i.createBuffer(),w=y.__size,A=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,x),i.bufferData(i.UNIFORM_BUFFER,w,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,M,x),x}function u(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const M=s[y.id],x=y.uniforms,w=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,M);for(let A=0,C=x.length;A<C;A++){const P=Array.isArray(x[A])?x[A]:[x[A]];for(let S=0,v=P.length;S<v;S++){const E=P[S];if(p(E,A,S,w)===!0){const D=E.__offset,L=Array.isArray(E.value)?E.value:[E.value];let N=0;for(let F=0;F<L.length;F++){const I=L[F],G=_(I);typeof I=="number"||typeof I=="boolean"?(E.__data[0]=I,i.bufferSubData(i.UNIFORM_BUFFER,D+N,E.__data)):I.isMatrix3?(E.__data[0]=I.elements[0],E.__data[1]=I.elements[1],E.__data[2]=I.elements[2],E.__data[3]=0,E.__data[4]=I.elements[3],E.__data[5]=I.elements[4],E.__data[6]=I.elements[5],E.__data[7]=0,E.__data[8]=I.elements[6],E.__data[9]=I.elements[7],E.__data[10]=I.elements[8],E.__data[11]=0):(I.toArray(E.__data,N),N+=G.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,D,E.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(y,M,x,w){const A=y.value,C=M+"_"+x;if(w[C]===void 0)return typeof A=="number"||typeof A=="boolean"?w[C]=A:w[C]=A.clone(),!0;{const P=w[C];if(typeof A=="number"||typeof A=="boolean"){if(P!==A)return w[C]=A,!0}else if(P.equals(A)===!1)return P.copy(A),!0}return!1}function g(y){const M=y.uniforms;let x=0;const w=16;for(let C=0,P=M.length;C<P;C++){const S=Array.isArray(M[C])?M[C]:[M[C]];for(let v=0,E=S.length;v<E;v++){const D=S[v],L=Array.isArray(D.value)?D.value:[D.value];for(let N=0,F=L.length;N<F;N++){const I=L[N],G=_(I),z=x%w,Q=z%G.boundary,X=z+Q;x+=Q,X!==0&&w-X<G.storage&&(x+=w-X),D.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),D.__offset=x,x+=G.storage}}}const A=x%w;return A>0&&(x+=w-A),y.__size=x,y.__cache={},this}function _(y){const M={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(M.boundary=4,M.storage=4):y.isVector2?(M.boundary=8,M.storage=8):y.isVector3||y.isColor?(M.boundary=16,M.storage=12):y.isVector4?(M.boundary=16,M.storage=16):y.isMatrix3?(M.boundary=48,M.storage=48):y.isMatrix4?(M.boundary=64,M.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),M}function m(y){const M=y.target;M.removeEventListener("dispose",m);const x=o.indexOf(M.__bindingPointIndex);o.splice(x,1),i.deleteBuffer(s[M.id]),delete s[M.id],delete r[M.id]}function f(){for(const y in s)i.deleteBuffer(s[y]);o=[],s={},r={}}return{bind:l,update:c,dispose:f}}class T1{constructor(t={}){const{canvas:e=Mf(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:d=!1}=t;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=o;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,f=null;const y=[],M=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Qe,this.toneMapping=Qn,this.toneMappingExposure=1;const x=this;let w=!1,A=0,C=0,P=null,S=-1,v=null;const E=new ue,D=new ue;let L=null;const N=new Ot(0);let F=0,I=e.width,G=e.height,z=1,Q=null,X=null;const et=new ue(0,0,I,G),at=new ue(0,0,I,G);let ft=!1;const B=new Gl;let $=!1,nt=!1;this.transmissionResolutionScale=1;const K=new ae,ct=new ae,st=new O,ht=new ue,wt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Tt=!1;function Nt(){return P===null?z:1}let U=n;function Gt(T,H){return e.getContext(T,H)}try{const T={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Il}`),e.addEventListener("webglcontextlost",ot,!1),e.addEventListener("webglcontextrestored",At,!1),e.addEventListener("webglcontextcreationerror",bt,!1),U===null){const H="webgl2";if(U=Gt(H,T),U===null)throw Gt(H)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let Rt,Lt,pt,ut,Ct,R,b,W,tt,it,j,vt,dt,gt,zt,lt,St,Dt,Ut,_t,Wt,Vt,Zt,V;function xt(){Rt=new Ng(U),Rt.init(),Vt=new _1(U,Rt),Lt=new Rg(U,Rt,t,Vt),pt=new m1(U,Rt),Lt.reverseDepthBuffer&&d&&pt.buffers.depth.setReversed(!0),ut=new Bg(U),Ct=new n1,R=new g1(U,Rt,pt,Ct,Lt,Vt,ut),b=new Lg(x),W=new Ug(x),tt=new Xp(U),Zt=new wg(U,tt),it=new Fg(U,tt,ut,Zt),j=new kg(U,it,tt,ut),Ut=new zg(U,Lt,R),lt=new Pg(Ct),vt=new e1(x,b,W,Rt,Lt,Zt,lt),dt=new E1(x,Ct),gt=new s1,zt=new h1(Rt),Dt=new Tg(x,b,W,pt,j,p,l),St=new f1(x,j,Lt),V=new A1(U,ut,Lt,pt),_t=new Cg(U,Rt,ut),Wt=new Og(U,Rt,ut),ut.programs=vt.programs,x.capabilities=Lt,x.extensions=Rt,x.properties=Ct,x.renderLists=gt,x.shadowMap=St,x.state=pt,x.info=ut}xt();const Z=new S1(x,U);this.xr=Z,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const T=Rt.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=Rt.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(T){T!==void 0&&(z=T,this.setSize(I,G,!1))},this.getSize=function(T){return T.set(I,G)},this.setSize=function(T,H,q=!0){if(Z.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}I=T,G=H,e.width=Math.floor(T*z),e.height=Math.floor(H*z),q===!0&&(e.style.width=T+"px",e.style.height=H+"px"),this.setViewport(0,0,T,H)},this.getDrawingBufferSize=function(T){return T.set(I*z,G*z).floor()},this.setDrawingBufferSize=function(T,H,q){I=T,G=H,z=q,e.width=Math.floor(T*q),e.height=Math.floor(H*q),this.setViewport(0,0,T,H)},this.getCurrentViewport=function(T){return T.copy(E)},this.getViewport=function(T){return T.copy(et)},this.setViewport=function(T,H,q,Y){T.isVector4?et.set(T.x,T.y,T.z,T.w):et.set(T,H,q,Y),pt.viewport(E.copy(et).multiplyScalar(z).round())},this.getScissor=function(T){return T.copy(at)},this.setScissor=function(T,H,q,Y){T.isVector4?at.set(T.x,T.y,T.z,T.w):at.set(T,H,q,Y),pt.scissor(D.copy(at).multiplyScalar(z).round())},this.getScissorTest=function(){return ft},this.setScissorTest=function(T){pt.setScissorTest(ft=T)},this.setOpaqueSort=function(T){Q=T},this.setTransparentSort=function(T){X=T},this.getClearColor=function(T){return T.copy(Dt.getClearColor())},this.setClearColor=function(){Dt.setClearColor.apply(Dt,arguments)},this.getClearAlpha=function(){return Dt.getClearAlpha()},this.setClearAlpha=function(){Dt.setClearAlpha.apply(Dt,arguments)},this.clear=function(T=!0,H=!0,q=!0){let Y=0;if(T){let k=!1;if(P!==null){const rt=P.texture.format;k=rt===zl||rt===Bl||rt===Ol}if(k){const rt=P.texture.type,mt=rt===kn||rt===Si||rt===Ks||rt===us||rt===Nl||rt===Fl,Et=Dt.getClearColor(),Mt=Dt.getClearAlpha(),Ft=Et.r,kt=Et.g,It=Et.b;mt?(g[0]=Ft,g[1]=kt,g[2]=It,g[3]=Mt,U.clearBufferuiv(U.COLOR,0,g)):(_[0]=Ft,_[1]=kt,_[2]=It,_[3]=Mt,U.clearBufferiv(U.COLOR,0,_))}else Y|=U.COLOR_BUFFER_BIT}H&&(Y|=U.DEPTH_BUFFER_BIT),q&&(Y|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(Y)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",ot,!1),e.removeEventListener("webglcontextrestored",At,!1),e.removeEventListener("webglcontextcreationerror",bt,!1),Dt.dispose(),gt.dispose(),zt.dispose(),Ct.dispose(),b.dispose(),W.dispose(),j.dispose(),Zt.dispose(),V.dispose(),vt.dispose(),Z.dispose(),Z.removeEventListener("sessionstart",sr),Z.removeEventListener("sessionend",rr),Tn.stop()};function ot(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),w=!0}function At(){console.log("THREE.WebGLRenderer: Context Restored."),w=!1;const T=ut.autoReset,H=St.enabled,q=St.autoUpdate,Y=St.needsUpdate,k=St.type;xt(),ut.autoReset=T,St.enabled=H,St.autoUpdate=q,St.needsUpdate=Y,St.type=k}function bt(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function Ht(T){const H=T.target;H.removeEventListener("dispose",Ht),le(H)}function le(T){ye(T),Ct.remove(T)}function ye(T){const H=Ct.get(T).programs;H!==void 0&&(H.forEach(function(q){vt.releaseProgram(q)}),T.isShaderMaterial&&vt.releaseShaderCache(T))}this.renderBufferDirect=function(T,H,q,Y,k,rt){H===null&&(H=wt);const mt=k.isMesh&&k.matrixWorld.determinant()<0,Et=Uo(T,H,q,Y,k);pt.setMaterial(Y,mt);let Mt=q.index,Ft=1;if(Y.wireframe===!0){if(Mt=it.getWireframeAttribute(q),Mt===void 0)return;Ft=2}const kt=q.drawRange,It=q.attributes.position;let Xt=kt.start*Ft,qt=(kt.start+kt.count)*Ft;rt!==null&&(Xt=Math.max(Xt,rt.start*Ft),qt=Math.min(qt,(rt.start+rt.count)*Ft)),Mt!==null?(Xt=Math.max(Xt,0),qt=Math.min(qt,Mt.count)):It!=null&&(Xt=Math.max(Xt,0),qt=Math.min(qt,It.count));const ee=qt-Xt;if(ee<0||ee===1/0)return;Zt.setup(k,Y,Et,q,Mt);let ie,$t=_t;if(Mt!==null&&(ie=tt.get(Mt),$t=Wt,$t.setIndex(ie)),k.isMesh)Y.wireframe===!0?(pt.setLineWidth(Y.wireframeLinewidth*Nt()),$t.setMode(U.LINES)):$t.setMode(U.TRIANGLES);else if(k.isLine){let Bt=Y.linewidth;Bt===void 0&&(Bt=1),pt.setLineWidth(Bt*Nt()),k.isLineSegments?$t.setMode(U.LINES):k.isLineLoop?$t.setMode(U.LINE_LOOP):$t.setMode(U.LINE_STRIP)}else k.isPoints?$t.setMode(U.POINTS):k.isSprite&&$t.setMode(U.TRIANGLES);if(k.isBatchedMesh)if(k._multiDrawInstances!==null)$t.renderMultiDrawInstances(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount,k._multiDrawInstances);else if(Rt.get("WEBGL_multi_draw"))$t.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{const Bt=k._multiDrawStarts,Te=k._multiDrawCounts,te=k._multiDrawCount,ln=Mt?tt.get(Mt).bytesPerElement:1,Ci=Ct.get(Y).currentProgram.getUniforms();for(let We=0;We<te;We++)Ci.setValue(U,"_gl_DrawID",We),$t.render(Bt[We]/ln,Te[We])}else if(k.isInstancedMesh)$t.renderInstances(Xt,ee,k.count);else if(q.isInstancedBufferGeometry){const Bt=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,Te=Math.min(q.instanceCount,Bt);$t.renderInstances(Xt,ee,Te)}else $t.render(Xt,ee)};function Qt(T,H,q){T.transparent===!0&&T.side===en&&T.forceSinglePass===!1?(T.side=He,T.needsUpdate=!0,wi(T,H,q),T.side=zn,T.needsUpdate=!0,wi(T,H,q),T.side=en):wi(T,H,q)}this.compile=function(T,H,q=null){q===null&&(q=T),f=zt.get(q),f.init(H),M.push(f),q.traverseVisible(function(k){k.isLight&&k.layers.test(H.layers)&&(f.pushLight(k),k.castShadow&&f.pushShadow(k))}),T!==q&&T.traverseVisible(function(k){k.isLight&&k.layers.test(H.layers)&&(f.pushLight(k),k.castShadow&&f.pushShadow(k))}),f.setupLights();const Y=new Set;return T.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;const rt=k.material;if(rt)if(Array.isArray(rt))for(let mt=0;mt<rt.length;mt++){const Et=rt[mt];Qt(Et,q,k),Y.add(Et)}else Qt(rt,q,k),Y.add(rt)}),M.pop(),f=null,Y},this.compileAsync=function(T,H,q=null){const Y=this.compile(T,H,q);return new Promise(k=>{function rt(){if(Y.forEach(function(mt){Ct.get(mt).currentProgram.isReady()&&Y.delete(mt)}),Y.size===0){k(T);return}setTimeout(rt,10)}Rt.get("KHR_parallel_shader_compile")!==null?rt():setTimeout(rt,10)})};let Ge=null;function an(T){Ge&&Ge(T)}function sr(){Tn.stop()}function rr(){Tn.start()}const Tn=new Au;Tn.setAnimationLoop(an),typeof self<"u"&&Tn.setContext(self),this.setAnimationLoop=function(T){Ge=T,Z.setAnimationLoop(T),T===null?Tn.stop():Tn.start()},Z.addEventListener("sessionstart",sr),Z.addEventListener("sessionend",rr),this.render=function(T,H){if(H!==void 0&&H.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),H.parent===null&&H.matrixWorldAutoUpdate===!0&&H.updateMatrixWorld(),Z.enabled===!0&&Z.isPresenting===!0&&(Z.cameraAutoUpdate===!0&&Z.updateCamera(H),H=Z.getCamera()),T.isScene===!0&&T.onBeforeRender(x,T,H,P),f=zt.get(T,M.length),f.init(H),M.push(f),ct.multiplyMatrices(H.projectionMatrix,H.matrixWorldInverse),B.setFromProjectionMatrix(ct),nt=this.localClippingEnabled,$=lt.init(this.clippingPlanes,nt),m=gt.get(T,y.length),m.init(),y.push(m),Z.enabled===!0&&Z.isPresenting===!0){const rt=x.xr.getDepthSensingMesh();rt!==null&&Ss(rt,H,-1/0,x.sortObjects)}Ss(T,H,0,x.sortObjects),m.finish(),x.sortObjects===!0&&m.sort(Q,X),Tt=Z.enabled===!1||Z.isPresenting===!1||Z.hasDepthSensing()===!1,Tt&&Dt.addToRenderList(m,T),this.info.render.frame++,$===!0&&lt.beginShadows();const q=f.state.shadowsArray;St.render(q,T,H),$===!0&&lt.endShadows(),this.info.autoReset===!0&&this.info.reset();const Y=m.opaque,k=m.transmissive;if(f.setupLights(),H.isArrayCamera){const rt=H.cameras;if(k.length>0)for(let mt=0,Et=rt.length;mt<Et;mt++){const Mt=rt[mt];ar(Y,k,T,Mt)}Tt&&Dt.render(T);for(let mt=0,Et=rt.length;mt<Et;mt++){const Mt=rt[mt];or(m,T,Mt,Mt.viewport)}}else k.length>0&&ar(Y,k,T,H),Tt&&Dt.render(T),or(m,T,H);P!==null&&C===0&&(R.updateMultisampleRenderTarget(P),R.updateRenderTargetMipmap(P)),T.isScene===!0&&T.onAfterRender(x,T,H),Zt.resetDefaultState(),S=-1,v=null,M.pop(),M.length>0?(f=M[M.length-1],$===!0&&lt.setGlobalState(x.clippingPlanes,f.state.camera)):f=null,y.pop(),y.length>0?m=y[y.length-1]:m=null};function Ss(T,H,q,Y){if(T.visible===!1)return;if(T.layers.test(H.layers)){if(T.isGroup)q=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(H);else if(T.isLight)f.pushLight(T),T.castShadow&&f.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||B.intersectsSprite(T)){Y&&ht.setFromMatrixPosition(T.matrixWorld).applyMatrix4(ct);const mt=j.update(T),Et=T.material;Et.visible&&m.push(T,mt,Et,q,ht.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||B.intersectsObject(T))){const mt=j.update(T),Et=T.material;if(Y&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),ht.copy(T.boundingSphere.center)):(mt.boundingSphere===null&&mt.computeBoundingSphere(),ht.copy(mt.boundingSphere.center)),ht.applyMatrix4(T.matrixWorld).applyMatrix4(ct)),Array.isArray(Et)){const Mt=mt.groups;for(let Ft=0,kt=Mt.length;Ft<kt;Ft++){const It=Mt[Ft],Xt=Et[It.materialIndex];Xt&&Xt.visible&&m.push(T,mt,Xt,q,ht.z,It)}}else Et.visible&&m.push(T,mt,Et,q,ht.z,null)}}const rt=T.children;for(let mt=0,Et=rt.length;mt<Et;mt++)Ss(rt[mt],H,q,Y)}function or(T,H,q,Y){const k=T.opaque,rt=T.transmissive,mt=T.transparent;f.setupLightsView(q),$===!0&&lt.setGlobalState(x.clippingPlanes,q),Y&&pt.viewport(E.copy(Y)),k.length>0&&Ti(k,H,q),rt.length>0&&Ti(rt,H,q),mt.length>0&&Ti(mt,H,q),pt.buffers.depth.setTest(!0),pt.buffers.depth.setMask(!0),pt.buffers.color.setMask(!0),pt.setPolygonOffset(!1)}function ar(T,H,q,Y){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[Y.id]===void 0&&(f.state.transmissionRenderTarget[Y.id]=new bi(1,1,{generateMipmaps:!0,type:Rt.has("EXT_color_buffer_half_float")||Rt.has("EXT_color_buffer_float")?tr:kn,minFilter:Mi,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Jt.workingColorSpace}));const rt=f.state.transmissionRenderTarget[Y.id],mt=Y.viewport||E;rt.setSize(mt.z*x.transmissionResolutionScale,mt.w*x.transmissionResolutionScale);const Et=x.getRenderTarget();x.setRenderTarget(rt),x.getClearColor(N),F=x.getClearAlpha(),F<1&&x.setClearColor(16777215,.5),x.clear(),Tt&&Dt.render(q);const Mt=x.toneMapping;x.toneMapping=Qn;const Ft=Y.viewport;if(Y.viewport!==void 0&&(Y.viewport=void 0),f.setupLightsView(Y),$===!0&&lt.setGlobalState(x.clippingPlanes,Y),Ti(T,q,Y),R.updateMultisampleRenderTarget(rt),R.updateRenderTargetMipmap(rt),Rt.has("WEBGL_multisampled_render_to_texture")===!1){let kt=!1;for(let It=0,Xt=H.length;It<Xt;It++){const qt=H[It],ee=qt.object,ie=qt.geometry,$t=qt.material,Bt=qt.group;if($t.side===en&&ee.layers.test(Y.layers)){const Te=$t.side;$t.side=He,$t.needsUpdate=!0,lr(ee,q,Y,ie,$t,Bt),$t.side=Te,$t.needsUpdate=!0,kt=!0}}kt===!0&&(R.updateMultisampleRenderTarget(rt),R.updateRenderTargetMipmap(rt))}x.setRenderTarget(Et),x.setClearColor(N,F),Ft!==void 0&&(Y.viewport=Ft),x.toneMapping=Mt}function Ti(T,H,q){const Y=H.isScene===!0?H.overrideMaterial:null;for(let k=0,rt=T.length;k<rt;k++){const mt=T[k],Et=mt.object,Mt=mt.geometry,Ft=Y===null?mt.material:Y,kt=mt.group;Et.layers.test(q.layers)&&lr(Et,H,q,Mt,Ft,kt)}}function lr(T,H,q,Y,k,rt){T.onBeforeRender(x,H,q,Y,k,rt),T.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),k.onBeforeRender(x,H,q,Y,T,rt),k.transparent===!0&&k.side===en&&k.forceSinglePass===!1?(k.side=He,k.needsUpdate=!0,x.renderBufferDirect(q,H,Y,k,T,rt),k.side=zn,k.needsUpdate=!0,x.renderBufferDirect(q,H,Y,k,T,rt),k.side=en):x.renderBufferDirect(q,H,Y,k,T,rt),T.onAfterRender(x,H,q,Y,k,rt)}function wi(T,H,q){H.isScene!==!0&&(H=wt);const Y=Ct.get(T),k=f.state.lights,rt=f.state.shadowsArray,mt=k.state.version,Et=vt.getParameters(T,k.state,rt,H,q),Mt=vt.getProgramCacheKey(Et);let Ft=Y.programs;Y.environment=T.isMeshStandardMaterial?H.environment:null,Y.fog=H.fog,Y.envMap=(T.isMeshStandardMaterial?W:b).get(T.envMap||Y.environment),Y.envMapRotation=Y.environment!==null&&T.envMap===null?H.environmentRotation:T.envMapRotation,Ft===void 0&&(T.addEventListener("dispose",Ht),Ft=new Map,Y.programs=Ft);let kt=Ft.get(Mt);if(kt!==void 0){if(Y.currentProgram===kt&&Y.lightsStateVersion===mt)return hr(T,Et),kt}else Et.uniforms=vt.getUniforms(T),T.onBeforeCompile(Et,x),kt=vt.acquireProgram(Et,Mt),Ft.set(Mt,kt),Y.uniforms=Et.uniforms;const It=Y.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(It.clippingPlanes=lt.uniform),hr(T,Et),Y.needsLights=Es(T),Y.lightsStateVersion=mt,Y.needsLights&&(It.ambientLightColor.value=k.state.ambient,It.lightProbe.value=k.state.probe,It.directionalLights.value=k.state.directional,It.directionalLightShadows.value=k.state.directionalShadow,It.spotLights.value=k.state.spot,It.spotLightShadows.value=k.state.spotShadow,It.rectAreaLights.value=k.state.rectArea,It.ltc_1.value=k.state.rectAreaLTC1,It.ltc_2.value=k.state.rectAreaLTC2,It.pointLights.value=k.state.point,It.pointLightShadows.value=k.state.pointShadow,It.hemisphereLights.value=k.state.hemi,It.directionalShadowMap.value=k.state.directionalShadowMap,It.directionalShadowMatrix.value=k.state.directionalShadowMatrix,It.spotShadowMap.value=k.state.spotShadowMap,It.spotLightMatrix.value=k.state.spotLightMatrix,It.spotLightMap.value=k.state.spotLightMap,It.pointShadowMap.value=k.state.pointShadowMap,It.pointShadowMatrix.value=k.state.pointShadowMatrix),Y.currentProgram=kt,Y.uniformsList=null,kt}function cr(T){if(T.uniformsList===null){const H=T.currentProgram.getUniforms();T.uniformsList=no.seqWithValue(H.seq,T.uniforms)}return T.uniformsList}function hr(T,H){const q=Ct.get(T);q.outputColorSpace=H.outputColorSpace,q.batching=H.batching,q.batchingColor=H.batchingColor,q.instancing=H.instancing,q.instancingColor=H.instancingColor,q.instancingMorph=H.instancingMorph,q.skinning=H.skinning,q.morphTargets=H.morphTargets,q.morphNormals=H.morphNormals,q.morphColors=H.morphColors,q.morphTargetsCount=H.morphTargetsCount,q.numClippingPlanes=H.numClippingPlanes,q.numIntersection=H.numClipIntersection,q.vertexAlphas=H.vertexAlphas,q.vertexTangents=H.vertexTangents,q.toneMapping=H.toneMapping}function Uo(T,H,q,Y,k){H.isScene!==!0&&(H=wt),R.resetTextureUnits();const rt=H.fog,mt=Y.isMeshStandardMaterial?H.environment:null,Et=P===null?x.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:fs,Mt=(Y.isMeshStandardMaterial?W:b).get(Y.envMap||mt),Ft=Y.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,kt=!!q.attributes.tangent&&(!!Y.normalMap||Y.anisotropy>0),It=!!q.morphAttributes.position,Xt=!!q.morphAttributes.normal,qt=!!q.morphAttributes.color;let ee=Qn;Y.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(ee=x.toneMapping);const ie=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,$t=ie!==void 0?ie.length:0,Bt=Ct.get(Y),Te=f.state.lights;if($===!0&&(nt===!0||T!==v)){const Ie=T===v&&Y.id===S;lt.setState(Y,T,Ie)}let te=!1;Y.version===Bt.__version?(Bt.needsLights&&Bt.lightsStateVersion!==Te.state.version||Bt.outputColorSpace!==Et||k.isBatchedMesh&&Bt.batching===!1||!k.isBatchedMesh&&Bt.batching===!0||k.isBatchedMesh&&Bt.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&Bt.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&Bt.instancing===!1||!k.isInstancedMesh&&Bt.instancing===!0||k.isSkinnedMesh&&Bt.skinning===!1||!k.isSkinnedMesh&&Bt.skinning===!0||k.isInstancedMesh&&Bt.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&Bt.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&Bt.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&Bt.instancingMorph===!1&&k.morphTexture!==null||Bt.envMap!==Mt||Y.fog===!0&&Bt.fog!==rt||Bt.numClippingPlanes!==void 0&&(Bt.numClippingPlanes!==lt.numPlanes||Bt.numIntersection!==lt.numIntersection)||Bt.vertexAlphas!==Ft||Bt.vertexTangents!==kt||Bt.morphTargets!==It||Bt.morphNormals!==Xt||Bt.morphColors!==qt||Bt.toneMapping!==ee||Bt.morphTargetsCount!==$t)&&(te=!0):(te=!0,Bt.__version=Y.version);let ln=Bt.currentProgram;te===!0&&(ln=wi(Y,H,k));let Ci=!1,We=!1,Cs=!1;const ce=ln.getUniforms(),$e=Bt.uniforms;if(pt.useProgram(ln.program)&&(Ci=!0,We=!0,Cs=!0),Y.id!==S&&(S=Y.id,We=!0),Ci||v!==T){pt.buffers.depth.getReversed()?(K.copy(T.projectionMatrix),Sf(K),bf(K),ce.setValue(U,"projectionMatrix",K)):ce.setValue(U,"projectionMatrix",T.projectionMatrix),ce.setValue(U,"viewMatrix",T.matrixWorldInverse);const Be=ce.map.cameraPosition;Be!==void 0&&Be.setValue(U,st.setFromMatrixPosition(T.matrixWorld)),Lt.logarithmicDepthBuffer&&ce.setValue(U,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(Y.isMeshPhongMaterial||Y.isMeshToonMaterial||Y.isMeshLambertMaterial||Y.isMeshBasicMaterial||Y.isMeshStandardMaterial||Y.isShaderMaterial)&&ce.setValue(U,"isOrthographic",T.isOrthographicCamera===!0),v!==T&&(v=T,We=!0,Cs=!0)}if(k.isSkinnedMesh){ce.setOptional(U,k,"bindMatrix"),ce.setOptional(U,k,"bindMatrixInverse");const Ie=k.skeleton;Ie&&(Ie.boneTexture===null&&Ie.computeBoneTexture(),ce.setValue(U,"boneTexture",Ie.boneTexture,R))}k.isBatchedMesh&&(ce.setOptional(U,k,"batchingTexture"),ce.setValue(U,"batchingTexture",k._matricesTexture,R),ce.setOptional(U,k,"batchingIdTexture"),ce.setValue(U,"batchingIdTexture",k._indirectTexture,R),ce.setOptional(U,k,"batchingColorTexture"),k._colorsTexture!==null&&ce.setValue(U,"batchingColorTexture",k._colorsTexture,R));const Ye=q.morphAttributes;if((Ye.position!==void 0||Ye.normal!==void 0||Ye.color!==void 0)&&Ut.update(k,q,ln),(We||Bt.receiveShadow!==k.receiveShadow)&&(Bt.receiveShadow=k.receiveShadow,ce.setValue(U,"receiveShadow",k.receiveShadow)),Y.isMeshGouraudMaterial&&Y.envMap!==null&&($e.envMap.value=Mt,$e.flipEnvMap.value=Mt.isCubeTexture&&Mt.isRenderTargetTexture===!1?-1:1),Y.isMeshStandardMaterial&&Y.envMap===null&&H.environment!==null&&($e.envMapIntensity.value=H.environmentIntensity),We&&(ce.setValue(U,"toneMappingExposure",x.toneMappingExposure),Bt.needsLights&&bs($e,Cs),rt&&Y.fog===!0&&dt.refreshFogUniforms($e,rt),dt.refreshMaterialUniforms($e,Y,z,G,f.state.transmissionRenderTarget[T.id]),no.upload(U,cr(Bt),$e,R)),Y.isShaderMaterial&&Y.uniformsNeedUpdate===!0&&(no.upload(U,cr(Bt),$e,R),Y.uniformsNeedUpdate=!1),Y.isSpriteMaterial&&ce.setValue(U,"center",k.center),ce.setValue(U,"modelViewMatrix",k.modelViewMatrix),ce.setValue(U,"normalMatrix",k.normalMatrix),ce.setValue(U,"modelMatrix",k.matrixWorld),Y.isShaderMaterial||Y.isRawShaderMaterial){const Ie=Y.uniformsGroups;for(let Be=0,No=Ie.length;Be<No;Be++){const si=Ie[Be];V.update(si,ln),V.bind(si,ln)}}return ln}function bs(T,H){T.ambientLightColor.needsUpdate=H,T.lightProbe.needsUpdate=H,T.directionalLights.needsUpdate=H,T.directionalLightShadows.needsUpdate=H,T.pointLights.needsUpdate=H,T.pointLightShadows.needsUpdate=H,T.spotLights.needsUpdate=H,T.spotLightShadows.needsUpdate=H,T.rectAreaLights.needsUpdate=H,T.hemisphereLights.needsUpdate=H}function Es(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(T,H,q){Ct.get(T.texture).__webglTexture=H,Ct.get(T.depthTexture).__webglTexture=q;const Y=Ct.get(T);Y.__hasExternalTextures=!0,Y.__autoAllocateDepthBuffer=q===void 0,Y.__autoAllocateDepthBuffer||Rt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),Y.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(T,H){const q=Ct.get(T);q.__webglFramebuffer=H,q.__useDefaultFramebuffer=H===void 0};const As=U.createFramebuffer();this.setRenderTarget=function(T,H=0,q=0){P=T,A=H,C=q;let Y=!0,k=null,rt=!1,mt=!1;if(T){const Mt=Ct.get(T);if(Mt.__useDefaultFramebuffer!==void 0)pt.bindFramebuffer(U.FRAMEBUFFER,null),Y=!1;else if(Mt.__webglFramebuffer===void 0)R.setupRenderTarget(T);else if(Mt.__hasExternalTextures)R.rebindTextures(T,Ct.get(T.texture).__webglTexture,Ct.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const It=T.depthTexture;if(Mt.__boundDepthTexture!==It){if(It!==null&&Ct.has(It)&&(T.width!==It.image.width||T.height!==It.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");R.setupDepthRenderbuffer(T)}}const Ft=T.texture;(Ft.isData3DTexture||Ft.isDataArrayTexture||Ft.isCompressedArrayTexture)&&(mt=!0);const kt=Ct.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(kt[H])?k=kt[H][q]:k=kt[H],rt=!0):T.samples>0&&R.useMultisampledRTT(T)===!1?k=Ct.get(T).__webglMultisampledFramebuffer:Array.isArray(kt)?k=kt[q]:k=kt,E.copy(T.viewport),D.copy(T.scissor),L=T.scissorTest}else E.copy(et).multiplyScalar(z).floor(),D.copy(at).multiplyScalar(z).floor(),L=ft;if(q!==0&&(k=As),pt.bindFramebuffer(U.FRAMEBUFFER,k)&&Y&&pt.drawBuffers(T,k),pt.viewport(E),pt.scissor(D),pt.setScissorTest(L),rt){const Mt=Ct.get(T.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+H,Mt.__webglTexture,q)}else if(mt){const Mt=Ct.get(T.texture),Ft=H;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,Mt.__webglTexture,q,Ft)}else if(T!==null&&q!==0){const Mt=Ct.get(T.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Mt.__webglTexture,q)}S=-1},this.readRenderTargetPixels=function(T,H,q,Y,k,rt,mt){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Et=Ct.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&mt!==void 0&&(Et=Et[mt]),Et){pt.bindFramebuffer(U.FRAMEBUFFER,Et);try{const Mt=T.texture,Ft=Mt.format,kt=Mt.type;if(!Lt.textureFormatReadable(Ft)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Lt.textureTypeReadable(kt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}H>=0&&H<=T.width-Y&&q>=0&&q<=T.height-k&&U.readPixels(H,q,Y,k,Vt.convert(Ft),Vt.convert(kt),rt)}finally{const Mt=P!==null?Ct.get(P).__webglFramebuffer:null;pt.bindFramebuffer(U.FRAMEBUFFER,Mt)}}},this.readRenderTargetPixelsAsync=async function(T,H,q,Y,k,rt,mt){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Et=Ct.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&mt!==void 0&&(Et=Et[mt]),Et){const Mt=T.texture,Ft=Mt.format,kt=Mt.type;if(!Lt.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Lt.textureTypeReadable(kt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(H>=0&&H<=T.width-Y&&q>=0&&q<=T.height-k){pt.bindFramebuffer(U.FRAMEBUFFER,Et);const It=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,It),U.bufferData(U.PIXEL_PACK_BUFFER,rt.byteLength,U.STREAM_READ),U.readPixels(H,q,Y,k,Vt.convert(Ft),Vt.convert(kt),0);const Xt=P!==null?Ct.get(P).__webglFramebuffer:null;pt.bindFramebuffer(U.FRAMEBUFFER,Xt);const qt=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await yf(U,qt,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,It),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,rt),U.deleteBuffer(It),U.deleteSync(qt),rt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(T,H=null,q=0){T.isTexture!==!0&&(Ki("WebGLRenderer: copyFramebufferToTexture function signature has changed."),H=arguments[0]||null,T=arguments[1]);const Y=Math.pow(2,-q),k=Math.floor(T.image.width*Y),rt=Math.floor(T.image.height*Y),mt=H!==null?H.x:0,Et=H!==null?H.y:0;R.setTexture2D(T,0),U.copyTexSubImage2D(U.TEXTURE_2D,q,0,0,mt,Et,k,rt),pt.unbindTexture()};const Ts=U.createFramebuffer(),ws=U.createFramebuffer();this.copyTextureToTexture=function(T,H,q=null,Y=null,k=0,rt=null){T.isTexture!==!0&&(Ki("WebGLRenderer: copyTextureToTexture function signature has changed."),Y=arguments[0]||null,T=arguments[1],H=arguments[2],rt=arguments[3]||0,q=null),rt===null&&(k!==0?(Ki("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),rt=k,k=0):rt=0);let mt,Et,Mt,Ft,kt,It,Xt,qt,ee;const ie=T.isCompressedTexture?T.mipmaps[rt]:T.image;if(q!==null)mt=q.max.x-q.min.x,Et=q.max.y-q.min.y,Mt=q.isBox3?q.max.z-q.min.z:1,Ft=q.min.x,kt=q.min.y,It=q.isBox3?q.min.z:0;else{const Ye=Math.pow(2,-k);mt=Math.floor(ie.width*Ye),Et=Math.floor(ie.height*Ye),T.isDataArrayTexture?Mt=ie.depth:T.isData3DTexture?Mt=Math.floor(ie.depth*Ye):Mt=1,Ft=0,kt=0,It=0}Y!==null?(Xt=Y.x,qt=Y.y,ee=Y.z):(Xt=0,qt=0,ee=0);const $t=Vt.convert(H.format),Bt=Vt.convert(H.type);let Te;H.isData3DTexture?(R.setTexture3D(H,0),Te=U.TEXTURE_3D):H.isDataArrayTexture||H.isCompressedArrayTexture?(R.setTexture2DArray(H,0),Te=U.TEXTURE_2D_ARRAY):(R.setTexture2D(H,0),Te=U.TEXTURE_2D),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,H.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,H.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,H.unpackAlignment);const te=U.getParameter(U.UNPACK_ROW_LENGTH),ln=U.getParameter(U.UNPACK_IMAGE_HEIGHT),Ci=U.getParameter(U.UNPACK_SKIP_PIXELS),We=U.getParameter(U.UNPACK_SKIP_ROWS),Cs=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,ie.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,ie.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Ft),U.pixelStorei(U.UNPACK_SKIP_ROWS,kt),U.pixelStorei(U.UNPACK_SKIP_IMAGES,It);const ce=T.isDataArrayTexture||T.isData3DTexture,$e=H.isDataArrayTexture||H.isData3DTexture;if(T.isDepthTexture){const Ye=Ct.get(T),Ie=Ct.get(H),Be=Ct.get(Ye.__renderTarget),No=Ct.get(Ie.__renderTarget);pt.bindFramebuffer(U.READ_FRAMEBUFFER,Be.__webglFramebuffer),pt.bindFramebuffer(U.DRAW_FRAMEBUFFER,No.__webglFramebuffer);for(let si=0;si<Mt;si++)ce&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ct.get(T).__webglTexture,k,It+si),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ct.get(H).__webglTexture,rt,ee+si)),U.blitFramebuffer(Ft,kt,mt,Et,Xt,qt,mt,Et,U.DEPTH_BUFFER_BIT,U.NEAREST);pt.bindFramebuffer(U.READ_FRAMEBUFFER,null),pt.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(k!==0||T.isRenderTargetTexture||Ct.has(T)){const Ye=Ct.get(T),Ie=Ct.get(H);pt.bindFramebuffer(U.READ_FRAMEBUFFER,Ts),pt.bindFramebuffer(U.DRAW_FRAMEBUFFER,ws);for(let Be=0;Be<Mt;Be++)ce?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ye.__webglTexture,k,It+Be):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Ye.__webglTexture,k),$e?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ie.__webglTexture,rt,ee+Be):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Ie.__webglTexture,rt),k!==0?U.blitFramebuffer(Ft,kt,mt,Et,Xt,qt,mt,Et,U.COLOR_BUFFER_BIT,U.NEAREST):$e?U.copyTexSubImage3D(Te,rt,Xt,qt,ee+Be,Ft,kt,mt,Et):U.copyTexSubImage2D(Te,rt,Xt,qt,Ft,kt,mt,Et);pt.bindFramebuffer(U.READ_FRAMEBUFFER,null),pt.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else $e?T.isDataTexture||T.isData3DTexture?U.texSubImage3D(Te,rt,Xt,qt,ee,mt,Et,Mt,$t,Bt,ie.data):H.isCompressedArrayTexture?U.compressedTexSubImage3D(Te,rt,Xt,qt,ee,mt,Et,Mt,$t,ie.data):U.texSubImage3D(Te,rt,Xt,qt,ee,mt,Et,Mt,$t,Bt,ie):T.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,rt,Xt,qt,mt,Et,$t,Bt,ie.data):T.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,rt,Xt,qt,ie.width,ie.height,$t,ie.data):U.texSubImage2D(U.TEXTURE_2D,rt,Xt,qt,mt,Et,$t,Bt,ie);U.pixelStorei(U.UNPACK_ROW_LENGTH,te),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,ln),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Ci),U.pixelStorei(U.UNPACK_SKIP_ROWS,We),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Cs),rt===0&&H.generateMipmaps&&U.generateMipmap(Te),pt.unbindTexture()},this.copyTextureToTexture3D=function(T,H,q=null,Y=null,k=0){return T.isTexture!==!0&&(Ki("WebGLRenderer: copyTextureToTexture3D function signature has changed."),q=arguments[0]||null,Y=arguments[1]||null,T=arguments[2],H=arguments[3],k=arguments[4]||0),Ki('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(T,H,q,Y,k)},this.initRenderTarget=function(T){Ct.get(T).__webglFramebuffer===void 0&&R.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?R.setTextureCube(T,0):T.isData3DTexture?R.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?R.setTexture2DArray(T,0):R.setTexture2D(T,0),pt.unbindTexture()},this.resetState=function(){A=0,C=0,P=null,pt.reset(),Zt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=Jt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Jt._getUnpackColorSpace()}}function w1(i){const t=new Ap,e=new ms(1,64,64),n=new Ao({map:t.load("./textures/earth_day_2k.png"),roughness:.8,metalness:.1}),s=new Ee(e,n);i.add(s);const r=new ms(1.015,64,64),o=new on({vertexShader:`
      varying vec3 vNormal;
      varying vec3 vPosition;
      void main() {
...
@font-face {
  ...
  `,document.head.appendChild(i)}function hv(i,t){const{onRebuild:e,onVisualChange:n,onIsoRebuild:s,onIsoVisualChange:r,onClipChange:o,onBeltRebuild:a,onBeltVisualChange:l,onSatelliteSwarmChange:c=()=>{},onSatelliteSearchOpen:h=()=>{},onSolarWindChange:u,onMagnetopauseChange:d,onParticleChange:p=()=>{},onAuroraChange:g=()=>{}}=t;cv();const _=new Ql({title:"Controls"}),m=_.addFolder("Magnetosphere");m.domElement.classList.add("section-magnetosphere");const f=m.addFolder("Field Lines");f.add(i,"maxDegree",1,13,1).name("IGRF Degree").onChange(()=>{e(),i.showIsosurfaces&&s(),(i.showInnerBelt||i.showOuterBelt)&&a()}),f.add(i,"numLatitudes",1,12,1).name("Latitude Bands").onChange(e),f.add(i,"numLongitudes",4,36,2).name("Longitudes").onChange(e),f.add(i,"tubeRadius",.003,.04,.001).name("Line Thickness").onChange(e),f.add(i,"showFieldLines").name("Show Field Lines").onChange(n),f.add(i,"autoRotate").name("Auto Rotate").onChange(n);const y=m.addFolder("Isosurfaces");y.add(i,"showIsosurfaces").name("Show Isosurfaces").onChange(st=>{st?s():r()}),y.add(i,"isoMode",{"L-shell (field topology)":"lShell","Field Strength |B|":"fieldStrength"}).name("Mode").onChange(s),y.add(i,"isoResolution",{Low:48,Medium:64,High:96}).name("Resolution").onChange(s),y.add(i,"isoOpacity",.05,.8,.01).name("Opacity").onChange(r);const M=y.addFolder("Levels");function x(){for(const st of[...M.controllers])st.destroy();for(const st of Object.keys(i.isoLevels)){const ht=i.isoMode==="lShell"?`L = ${st}`:`${Number(st).toLocaleString()} nT`;M.add(i.isoLevels,st).name(ht).onChange(r)}}x(),i._rebuildLevelToggles=x,M.close(),y.close();const w=_.addFolder("Solar Wind");w.domElement.classList.add("section-solar-wind");const A={"Historical Data":null,Quiet:{vSw:400,nSw:5,imfBy:0,imfBz:0,dst:0},"Moderate Storm":{vSw:500,nSw:10,imfBy:2,imfBz:-5,dst:-50},"Severe Storm":{vSw:700,nSw:20,imfBy:5,imfBz:-15,dst:-150}};w.add(i,"solarWindEnabled").name("Enable Solar Wind").onChange(u),i._solarPreset="Historical Data";const C=w.add(i,"_solarPreset",Object.keys(A)).name("Preset").onChange(st=>{const ht=A[st];ht&&(i.solarWindSpeed=ht.vSw,i.solarWindDensity=ht.nSw,i.imfBy=ht.imfBy,i.imfBz=ht.imfBz,i.dst=ht.dst,_.controllersRecursive().forEach(wt=>wt.updateDisplay()),i.solarWindEnabled&&u())}),P=w.add(i,"solarWindSpeed",300,800,10).name("Speed (km/s)").onChange(()=>{i.solarWindEnabled&&u()}),S=w.add(i,"solarWindDensity",1,30,.5).name("Density (cm⁻³)").onChange(()=>{i.solarWindEnabled&&u()}),v=w.add(i,"imfBy",-20,20,.5).name("IMF By (nT)").onChange(()=>{i.solarWindEnabled&&u()}),E=w.add(i,"imfBz",-20,20,.5).name("IMF Bz (nT)").onChange(()=>{i.solarWindEnabled&&u()}),D=w.add(i,"dst",-200,50,5).name("Dst Index (nT)").onChange(()=>{i.solarWindEnabled&&u()});w.add(i,"showMagnetopause").name("Show Magnetopause").onChange(d),w.close();const L=_.addFolder("Radiation & Aurora");L.domElement.classList.add("section-radiation");const N=L.addFolder("Radiation Belts");N.add(i,"showInnerBelt").name("Inner Belt (L=1.2-2)").onChange(st=>{st?a():l()}),N.add(i,"showOuterBelt").name("Outer Belt (L=3-6)").onChange(st=>{st?a():l()}),N.add(i,"beltOpacity",.05,.8,.01).name("Opacity").onChange(l),N.close();const F=L.addFolder("Belt Particles");F.add(i.particles,"enabled").name("Show Particles");const I=F.add(i.particles,"showElectrons").name("Electrons (eastward)");I.$name.innerHTML='<span style="color:#3399ff">●</span> Electrons (eastward)';const G=F.add(i.particles,"showProtons").name("Protons (westward)");G.$name.innerHTML='<span style="color:#ff6622">●</span> Protons (westward)',F.add(i.particles,"count",200,2e3,100).name("Max Particles"),F.add(i.particles,"energyMeV",{"< 1 MeV (low)":.3,"1–3 MeV (medium)":2,"> 3 MeV (high)":5}).name("Electron Energy"),F.close();const z=L.addFolder("Aurora");z.add(i.aurora,"enabled").name("Show Aurora"),z.add(i.aurora,"opacity",.1,2,.05).name("Brightness"),z.close(),L.close();const Q=_.addFolder("Satellites");Q.domElement.classList.add("section-satellites"),Q.add(i.satellites,"enabled").name("Show Satellites").onChange(c),Q.add(i.satellites,"notableOnly").name("Notable Only").onChange(c);const X=Q.addFolder("Orbit Classes"),et=X.add(i.satellites,"showLeo").name("LEO").onChange(c);et.$name.innerHTML='<span style="color:#c8d8f0">●</span> LEO';const at=X.add(i.satellites,"showMeo").name("MEO").onChange(c);at.$name.innerHTML='<span style="color:#44eebb">●</span> MEO';const ft=X.add(i.satellites,"showGeo").name("GEO").onChange(c);ft.$name.innerHTML='<span style="color:#ffdd44">●</span> GEO';const B=X.add(i.satellites,"showHeo").name("HEO").onChange(c);B.$name.innerHTML='<span style="color:#ee66ff">●</span> HEO';const $=X.add(i.satellites,"showOther").name("Other").onChange(c);$.$name.innerHTML='<span style="color:#888888">●</span> Other',X.close();const nt=document.createElement("button");nt.id="sat-open-btn",nt.textContent="Search / Select Satellite",nt.style.cssText=["width:100%","box-sizing:border-box","margin:4px 0","padding:5px 8px","background:rgba(30,50,80,0.7)","color:#88ccff","border:1px solid rgba(100,150,200,0.35)","border-radius:4px","cursor:pointer","font-family:var(--font-family)","font-size:11px"].join(";"),nt.addEventListener("mouseenter",()=>{nt.style.background="rgba(50,80,120,0.8)"}),nt.addEventListener("mouseleave",()=>{nt.style.background="rgba(30,50,80,0.7)"}),nt.addEventListener("click",h),Q.$children.appendChild(nt),Q.close();const K=_.addFolder("Clipping");K.domElement.classList.add("section-clipping"),K.add(i,"clipEquatorial").name("Equatorial Clip").onChange(o),K.add(i,"clipMeridional").name("Meridional Clip").onChange(o),K.add(i,"clipMeridionalAngle",0,360,1).name("Meridional Angle").onChange(o),K.close();function ct(){C.updateDisplay(),P.updateDisplay(),S.updateDisplay(),v.updateDisplay(),E.updateDisplay(),D.updateDisplay()}return{gui:_,refreshSolarWindControls:ct}}function uv(){const i=document.createElement("div");i.id="info-overlay",i.innerHTML=`
  ...
  `,document.head.appendChild(i)}function gv({initialTime:i,onTimeChange:t,onPause:e,onPeriodicRebuild:n,getSolarWindData:s}){const r=n||e;let o=new Date(i),a=ya(o),l=!1,c=60,h=null,u=0,d=!1;mv();const p=document.createElement("div");p.id="timeline",p.innerHTML=`
    <div id="tl-controls">
...
`;function Kx(i){const t=new Float32Array(be),e=new Float32Array(be),n=new Float32Array(be),s=new Float32Array(be),r=new Float32Array(be),o=new Float32Array(be),a=new Uint8Array(be),l=new Uint8Array(be),c=new Float32Array(be),h=new Float32Array(be),u=new Float32Array(be*3),d=new Float32Array(be*3),p=new Ae,g=new de(u,3),_=new de(d,3);g.setUsage(Ws),_.setUsage(Ws),p.setAttribute("position",g),p.setAttribute("particleColor",_),p.setDrawRange(0,be),p.boundingSphere=new vs(new O(0,0,0),7);const m=new on({vertexShader:$x,fragmentShader:Yx,uniforms:{uDPR:{value:window.devicePixelRatio??1}},transparent:!0,depthWrite:!1,blending:ei}),f=new fu(p,m);f.frustumCulled=!1,i.add(f);let y=0,M=0,x=0,w=0,A=0,C=0,P=0,S=0,v=!1,E=0;function D(){for(let X=0;X<be;X++){const et=(E+X)%be;if(!a[et])return E=(et+1)%be,et}return-1}function L(X,et,at,ft,B,$,nt,K){const ct=Math.acos(Math.sqrt(1/Math.max(et,1)))*.35,st=(Math.random()-.5)*2*ct,ht=bx(et,B,ft)*Rx,wt=Math.cos(st),Tt=et*wt*wt;t[X]=et,e[X]=at,n[X]=st,c[X]=Tt*wt,h[X]=Tt*Math.sin(st),s[X]=ht,r[X]=$,o[X]=0,a[X]=1,l[X]=K,K===0?y++:K===1?M++:K===2?x++:w++,d[X*3]=nt.r,d[X*3+1]=nt.g,d[X*3+2]=nt.b}function N(){const X=D();if(X===-1)return;const{lMin:et,lMax:at}=wx(),ft=et+Math.random()*(at-et),B=Math.random()*Math.PI*2;L(X,ft,B,Ah,Bx,Cx(ft),Ea,0)}function F(){const X=D();if(X===-1)return;const{lMin:et,lMax:at}=Ax(),ft=et+Math.random()*(at-et),B=Math.random()*Math.PI*2;L(X,ft,B,xo,zx,Vx,ba,1)}function I(X,et,at){const{lMin:ft,lMax:B}=Ex(at),$=ft+Math.random()*(B-ft);if($>=Nx&&$<=Fx&&at>Ox)return;const nt=D();if(nt===-1)return;const K=Math.PI-et+(Math.random()-.5)*Math.PI;L(nt,$,K,xo,X,wh($),ba,2)}function G(X,et){const{lMin:at,lMax:ft}=Tx(et),B=at+Math.random()*(ft-at),$=D();if($===-1)return;const nt=Math.PI-X+(Math.random()-.5)*Math.PI;L($,B,nt,Ah,kx,wh(B),Ea,3)}function z(X,et,at,ft=1){if(!at.enabled){f.visible=!1,v=!1;return}f.visible=!0;const B=(et==null?void 0:et.dst)??0,$=(et==null?void 0:et.sunLonRad)??0,nt=Math.min(1,Math.abs(B)/150),K=Math.cos($),ct=Math.sin($),st=at.showElectrons??!0,ht=at.showProtons??!0,wt=at.energyMeV??1,Tt=Math.max(50,Math.min(at.count??800,be)),{budgetA:Nt,budgetB:U,budgetC:Gt,budgetD:Rt}=qx(Tt,B,st,ht);if(!v){if(v=!0,ht){for(let ut=0;ut<Math.floor(Nt*Px);ut++)N();for(let ut=0;ut<Math.floor(Rt*Ix);ut++)G($,B)}if(st){for(let ut=0;ut<Math.floor(U*Lx);ut++)F();for(let ut=0;ut<Math.floor(Gt*Dx);ut++)I(wt,$,B)}A=C=P=S=0}if(ht){for(A+=Al()*X;A>=1&&y<Nt;)A-=1,N();A>Al()&&(A=0);const ut=bl(B)*qu;for(S+=ut*X;S>=1&&w<Rt;)S-=1,G($,B);S>ut&&(S=0)}if(st){for(C+=El()*X;C>=1&&M<U;)C-=1,F();C>El()&&(C=0);const ut=bl(B)*Xu;for(P+=ut*X;P>=1&&x<Gt;)P-=1,I(wt,$,B);P>ut&&(P=0)}let Lt=!1,pt=!1;for(let ut=0;ut<be;ut++){if(!a[ut])continue;if(Math.random()<1-Math.exp(-X/r[ut])){a[ut]=0;const dt=l[ut];dt===0?y--:dt===1?M--:dt===2?x--:w--,d[ut*3]=d[ut*3+1]=d[ut*3+2]=0,u[ut*3]=u[ut*3+1]=u[ut*3+2]=0,Lt=pt=!0;continue}e[ut]=(e[ut]+s[ut]*X)%(Math.PI*2);const Ct=Math.cos(e[ut]),R=Math.sin(e[ut]);let b=c[ut]*Ct,W=h[ut],tt=-c[ut]*R;if(nt>.01&&l[ut]>=2){const dt=c[ut];if(dt>1e-6){const gt=(b*K+tt*ct)/dt,zt=1-nt*.22*gt;b*=zt,W*=zt,tt*=zt}}u[ut*3]=b,u[ut*3+1]=W,u[ut*3+2]=tt,Lt=!0,o[ut]+=X;const j=1+(o[ut]<Th?Ux*(1-o[ut]/Th):0),vt=s[ut]>=0?ba:Ea;d[ut*3]=vt.r*j,d[ut*3+1]=vt.g*j,d[ut*3+2]=vt.b*j,pt=!0}Lt?(g.needsUpdate=!0,_.needsUpdate=!0):pt&&(_.needsUpdate=!0)}function Q(){i.remove(f),p.dispose(),m.dispose()}return{mesh:f,update:z,dispose:Q}}const jx=67,$u=jx*Math.PI/180,Yu=1.02,Zx=Yu*Math.cos($u),Jx=Yu*Math.sin($u),Ku=.03,Qx=`
...
`;function ju(i,t){const e=window.devicePixelRatio??1,n={leo:[],meo:[],geo:[],heo:[],other:[]},s=new Array(t.length);for(let E=0;E<t.length;E++){const D=t[E].orbitClass,L=n[D].length;n[D].push(E),s[E]={orbitClass:D,localIndex:L}}const r={},o=new yn;i.add(o);for(const E of Vs){const D=n[E].length;if(D===0){r[E]=null;continue}const L=new Ae,N=new Float32Array(D*3),F=new Float32Array(D*3),I=new Float32Array(D),G=Ph[E],z=E==="geo"?14:E==="heo"?12:11;for(let B=0;B<D;B++)F[B*3]=G.r,F[B*3+1]=G.g,F[B*3+2]=G.b,I[B]=z,N[B*3+1]=-2;const Q=new de(N,3),X=new de(F,3),et=new de(I,1);Q.setUsage(Ws),X.setUsage(Ws),et.setUsage(Ws),L.setAttribute("position",Q),L.setAttribute("satColor",X),L.setAttribute("satSize",et);const at=new on({uniforms:{uDPR:{value:e}},vertexShader:aM,fragmentShader:lM,transparent:!0,blending:ei,depthWrite:!1}),ft=new fu(L,at);ft.frustumCulled=!1,o.add(ft),r[E]={points:ft,posAttr:Q,colorAttr:X,sizeAttr:et,baseColor:G,baseSize:z}}let a=-1,l=null,c=null,h=null,u=1,d=0,p=1e4,g=0,_=0,m=null;const f=2e3;function y(E,D){if(!E||D===0)return;const L=performance.now(),N=Math.min(D,t.length);if(!h){h=new Float32Array(t.length*3),c=new Float32Array(t.length*3);for(let I=0;I<N;I++)h[I*3]=E[I*3],h[I*3+1]=E[I*3+1],h[I*3+2]=E[I*3+2];c.set(h),d=L,u=1,M(h);return}d>0&&(p=Math.max(200,L-d)),d=L;const F=c;c=h,h=F;for(let I=0;I<N;I++)h[I*3]=E[I*3],h[I*3+1]=E[I*3+1],h[I*3+2]=E[I*3+2];u=0}function M(E){for(let D=0;D<t.length;D++){const L=s[D];if(!L)continue;const N=r[L.orbitClass];if(!N)continue;const F=L.localIndex;N.posAttr.array[F*3]=E[D*3],N.posAttr.array[F*3+1]=E[D*3+1],N.posAttr.array[F*3+2]=E[D*3+2]}for(const D of Vs)r[D]&&(r[D].posAttr.needsUpdate=!0)}function x(E){if(!h||!c||u>=1)return;u=Math.min(1,(E-d)/p);const D=u,L=1-D;for(let N=0;N<t.length;N++){const F=s[N];if(!F)continue;const I=r[F.orbitClass];if(!I)continue;const G=F.localIndex;I.posAttr.array[G*3]=c[N*3]*L+h[N*3]*D,I.posAttr.array[G*3+1]=c[N*3+1]*L+h[N*3+1]*D,I.posAttr.array[G*3+2]=c[N*3+2]*L+h[N*3+2]*D}for(const N of Vs)r[N]&&(r[N].posAttr.needsUpdate=!0)}function w(E){if(a>=0&&a<t.length){const D=s[a],L=r[D.orbitClass];if(L){const N=D.localIndex,F=L.baseColor;L.colorAttr.array[N*3]=F.r,L.colorAttr.array[N*3+1]=F.g,L.colorAttr.array[N*3+2]=F.b,L.sizeAttr.array[N]=L.baseSize,L.colorAttr.needsUpdate=!0,L.sizeAttr.needsUpdate=!0}}if(a=E,E>=0&&E<t.length){const D=s[E],L=r[D.orbitClass];if(L){const N=D.localIndex;L.colorAttr.array[N*3]=Aa.r,L.colorAttr.array[N*3+1]=Aa.g,L.colorAttr.array[N*3+2]=Aa.b,L.sizeAttr.array[N]=L.baseSize*2.5,L.colorAttr.needsUpdate=!0,L.sizeAttr.needsUpdate=!0}}}function A(E,D){if(P(),!E||E.length<6)return;const L=new Ae;L.setAttribute("position",new de(E.slice(),3)),_=E.length/3,g=1,L.setDrawRange(0,1);const N=Ph[D]??new Ot(16777215),F=new du({color:N,transparent:!0,opacity:.8,depthWrite:!1});l=new jf(L,F),l.frustumCulled=!1,i.add(l),m=performance.now()}function C(E){if(!l||g>=_)return;const D=E-m,L=Math.min(1,D/f);g=Math.max(2,Math.floor(L*_)),l.geometry.setDrawRange(0,g)}function P(){l&&(i.remove(l),l.geometry.dispose(),l.material.dispose(),l=null),g=0,_=0,m=null}function S(E){var L;const D={leo:E.showLeo,meo:E.showMeo,geo:E.showGeo,heo:E.showHeo,other:E.showOther};for(const N of Vs)r[N]&&(r[N].points.visible=D[N]);if(a>=0){const N=(L=s[a])==null?void 0:L.orbitClass;N&&!D[N]&&P()}}function v(){P();for(const E of Vs){const D=r[E];D&&(D.points.geometry.dispose(),D.points.material.dispose())}i.remove(o)}return{group:o,updatePositions:y,lerpPositions:x,setSelected:w,setOrbitTrace:A,tickOrbitTrace:C,clearOrbitTrace:P,applyVisibility:S,dispose:v,getSelectedGlobalIndex:()=>a}}function cM(i,t,e,n){const s=t.trim().toLowerCase(),r=new Set(e);return i.filter(o=>{if(!r.has(o.orbitClass)||n&&!o.notable)return!1;if(s){const a=o.name.toLowerCase().includes(s),l=String(o.id).includes(s);if(!a&&!l)return!1}return!0})}function tc(i){return{leo:"LEO",meo:"MEO",geo:"GEO",heo:"HEO",other:"OTHER"}[i]??i.toUpperCase()}function hM(i,t){return i.findIndex(e=>e.id===t)}function ec(i){const t=parseFloat(i.substring(52,63));return!isFinite(t)||t<=0?0:1440/t}const uM={leo:"#3a6080",meo:"#1a6050",geo:"#706020",heo:"#602060",other:"#404040"};let Ze=null,yi=null,Je=null,Sn=null,Js=!1,Ei=[],Zu="",Tl=["leo","meo","geo","heo"],Ju=!0,Gs=null,Lh=null;function dM(){if(document.getElementById("sat-panel-styles"))return;const i=document.createElement("style");i.id="sat-panel-styles",i.textContent=`
    #sat-panel {
      position: fixed;
      top: 60px;
  ...
  `,Gs&&Gs(i)}function Qu(i){const t=parseFloat(i.substring(52,63));if(!isFinite(t)||t<=0)return 0;const e=398600.4418,n=t*2*Math.PI/86400,s=Math.pow(e/(n*n),1/3);return Math.max(0,s-6371.2)}function td(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function gM(i,t={}){Ei=i,Gs=t.onSelect??null,fM(),Lo()}function _M(){Ze&&(Ze.classList.add("visible"),Js=!0,Je==null||Je.focus())}function so(){Ze&&(Ze.classList.remove("visible"),Js=!1)}function vM(){Js?so():_M()}function xM(i,t){Tl=i,Ju=t,Lo()}function MM(i){if(nc=i,i>=0&&i<Ei.length){const t=Ei[i],e=ec(t.line2),n=Qu(t.line2);Sn.style.display="block",Sn.innerHTML=`
    ...
    `}else Sn.style.display="none"}const J={maxDegree:13,numLatitudes:4,numLongitudes:8,tubeRadius:.008,showFieldLines:!0,autoRotate:!1,showIsosurfaces:!1,isoMode:"lShell",isoResolution:64,isoOpacity:.2,isoLevels:{},showInnerBelt:!1,showOuterBelt:!1,beltOpacity:.15,clipEquatorial:!1,clipMeridional:!1,clipMeridionalAngle:0,solarWindEnabled:!0,solarWindSpeed:400,solarWindDensity:5,imfBy:0,imfBz:0,dst:0,g1:0,g2:0,sunLongitude:0,sunDeclination:0,showMagnetopause:!1,datetimeString:"2025-11-06T00:00",particles:{enabled:!1,showElectrons:!0,showProtons:!0,count:800,energyMeV:1},aurora:{enabled:!1,opacity:1},satellites:{enabled:!1,showLeo:!0,showMeo:!0,showGeo:!0,showHeo:!0,showOther:!1,notableOnly:!0}},{params:rn,isoLevels:Dh,camera:qr}=sM();rn.particles&&(Object.assign(J.particles,rn.particles),delete rn.particles);rn.aurora&&(Object.assign(J.aurora,rn.aurora),delete rn.aurora);rn.satellites&&(Object.assign(J.satellites,rn.satellites),delete rn.satellites);Object.assign(J,rn);function ed(){if(J.isoLevels={},J.isoMode==="lShell")for(const i of Sv)J.isoLevels[i]=[2,4,6,10].includes(i);else for(const i of yv)J.isoLevels[i]=[1e4,5e3,2e3,500].includes(i)}ed();function Ai(){return J.solarWindEnabled?{enabled:!0,vSw:J.solarWindSpeed,nSw:J.solarWindDensity,imfBy:J.imfBy,imfBz:J.imfBz,dst:J.dst,g1:J.g1,g2:J.g2,sunLonRad:J.sunLongitude*Math.PI/180,ps:J.sunDeclination*Math.PI/180}:null}const yM=[[55],[40,65],[30,50,70],[25,40,55,70],[20,35,50,60,72],[20,30,42,54,64,75],[18,28,38,48,58,68,78],[15,24,33,42,51,60,69,78],[14,22,30,38,46,54,62,70,78],[12,20,28,36,44,52,60,68,74,80],[12,19,26,33,40,47,54,61,68,74,80],[10,17,24,31,38,45,52,59,66,72,78,82]],Hn=new T1({antialias:!0});Hn.setPixelRatio(window.devicePixelRatio);Hn.setSize(window.innerWidth,window.innerHeight);Hn.toneMapping=kh;Hn.toneMappingExposure=1;Hn.localClippingEnabled=!0;document.body.appendChild(Hn.domElement);const ge=new qf;ge.background=new Ot(8);const fe=new tn(45,window.innerWidth/window.innerHeight,.01,500);fe.position.set(0,1.5,4);w1(ge);const{sunLight:SM}=D1(ge),$s=C1(ge),Ih=R1(ge),Do=$1(fe,Hn);qr&&(fe.position.set(qr.x,qr.y,qr.z),Do.update());Do.addEventListener("change",()=>De(J,fe));const Mo=Ov();let Pe=null,nd=0,id=8200,$r=null,ke=null,yo=null,wl=null;function sd(i,t){const{epochs:e,g:n,h:s,sv_g:r,sv_h:o,svEpoch:a,nmax:l,referenceRadius:c}=i;if(t>=a){const d=t-a,p=e.length-1;return{epoch:t,nmax:l,referenceRadius:c,sv_g:r,sv_h:o,g:n[p].map((g,_)=>g.map((m,f)=>m+d*r[_][f])),h:s[p].map((g,_)=>g.map((m,f)=>m+d*o[_][f]))}}let h=e.length-2;for(let d=0;d<e.length-1;d++)if(t>=e[d]&&t<e[d+1]){h=d;break}const u=(t-e[h])/(e[h+1]-e[h]);return{epoch:t,nmax:l,referenceRadius:c,sv_g:r,sv_h:o,g:n[h].map((d,p)=>d.map((g,_)=>g+u*(n[h+1][p][_]-g))),h:s[h].map((d,p)=>d.map((g,_)=>g+u*(s[h+1][p][_]-g)))}}function rd(i){if(!yo)return;const t=i.getUTCFullYear();t!==wl&&(wl=t,ke=sd(yo,t))}async function bM(){yo=await(await fetch("./data/igrf/igrf14-all.json")).json();const t=new Date(J.datetimeString).getUTCFullYear();wl=t,ke=sd(yo,t)}function EM(){return $r||($r=new Worker(new URL(""+new URL("fieldLineWorker-DQ34Blhd.js",import.meta.url).href,import.meta.url),{type:"module"}),$r.onmessage=AM),$r}function AM(i){const{type:t,buildId:e,tracedLines:n}=i.data;if(t!=="fieldLinesReady"||e!==nd)return;const s=n.filter(a=>a.points.length>=2);Pe!==null&&Pe.children.length===s.length?TM(s,id):od(s);const o=document.getElementById("loading");o&&(o.style.display="none")}function Io(i=8200,t=!0){const e=++nd;if(id=i,t){const r=document.getElementById("loading");r&&(r.style.display="")}const n=Ai(),s=J.solarWindEnabled;EM().postMessage({buildId:e,latitudes:yM[J.numLatitudes-1],nLongitudes:J.numLongitudes,bothHemispheres:s,polarCapLatitudes:s?[85,88]:[],coeffs:ke,maxDegree:J.maxDegree,solarWindParams:n})}function od(i){jn=null,Pe&&(ge.remove(Pe),Pe.traverse(t=>{t.geometry&&t.geometry.dispose(),t.material&&t.material.dispose()}),Pe=null),Pe=Y1(i,Nu,{radius:J.tubeRadius}),Pe.visible=J.showFieldLines,ge.add(Pe),Pe.children.forEach((t,e)=>{t.userData.isOpen=i[e].isOpen??!1}),gd()}function TM(i,t=8200){const e=[];for(let n=0;n<Pe.children.length;n++){const s=Pe.children[n],r=i[n],o=Uu(r.points,{color:Nu(r.lat),radius:J.tubeRadius,tubularSegments:Iu});if(!o){od(i);return}const a=s.userData.isOpen??!1,l=r.isOpen??!1,c=a!==l,h=c?DM:t,u=c?UM:IM;s.userData.isOpen=l,e.push({mesh:s,oldPos:s.geometry.attributes.position.array.slice(),newPos:o.geometry.attributes.position.array.slice(),lineDuration:h,easing:u}),o.geometry.dispose(),o.material.dispose()}jn={startTime:performance.now(),duration:Math.max(...e.map(n=>n.lineDuration)),lines:e}}function wM(i){if(!jn)return;const t=i-jn.startTime,e=t/jn.duration;for(const{mesh:n,oldPos:s,newPos:r,lineDuration:o,easing:a}of jn.lines){const l=Math.min(1,t/o),c=a(l),h=n.geometry.attributes.position.array;for(let u=0;u<h.length;u++)h[u]=s[u]+c*(r[u]-s[u]);n.geometry.attributes.position.needsUpdate=!0,n.geometry.computeVertexNormals(),n.geometry.computeBoundingSphere()}e>=1&&(jn=null)}function ad(){Pe&&(Pe.visible=J.showFieldLines),Do.autoRotate=J.autoRotate,De(J,fe)}let Ta=null,Cl=null,ld=null,ic=null,Rl=null,cd=null,sc=null,Ve=null,Fe=null,pi={innerFlux:.65,outerFlux:.1,slotFlux:0};const as=12,hd=[-as,-as,-as],ud=[as,as,as];function CM(){return Ta||(Ta=new Worker(new URL(""+new URL("scalarFieldWorker-BIDCwx3E.js",import.meta.url).href,import.meta.url),{type:"module"})),Ta}function rc(i,t){if(J.isoMode==="lShell"){if(Rl&&cd===i&&sc===t)return Rl}else if(Cl&&ld===i&&ic===t)return Cl;return null}function oc(){if(De(J,fe),!J.showIsosurfaces||!ke)return;ed(),J._rebuildLevelToggles&&J._rebuildLevelToggles();const i=Number(J.isoResolution),t=J.maxDegree;if(rc(t,i)){ro();return}const e=J.isoMode==="lShell",n=e?"computeLShellGrid":"computeGrid",s=e?"L-shell":"|B|";wa(!0,`Computing ${s} field...`);const r=CM();r.onmessage=o=>{o.data.type==="progress"?PM(o.data.percent,s):o.data.type==="gridReady"?(Cl=o.data.grid,ld=t,ic=o.data.resolution,wa(!1),ro()):o.data.type==="lshellGridReady"&&(Rl=o.data.grid,cd=t,sc=o.data.resolution,wa(!1),ro())},r.postMessage({type:n,coeffs:ke,maxDegree:t,resolution:i,boundsMin:hd,boundsMax:ud})}function ro(){const i=Number(J.isoResolution),t=J.maxDegree,e=rc(t,i);if(!e||(Ve&&(ge.remove(Ve),Fu(Ve),Ve=null),!J.showIsosurfaces))return;const n=J.isoMode==="lShell"?sc:ic,s=[];for(const[o,a]of Object.entries(J.isoLevels)){if(!a)continue;const l=Number(o),{positions:c,normals:h,indices:u}=xv(e,n,hd,ud,l);s.push({level:l,positions:c,normals:h,indices:u})}if(s.length===0)return;const r=Mo.getActivePlanes(J.clipEquatorial,J.clipMeridional);Ve=bv(s,{opacity:J.isoOpacity,clippingPlanes:r,mode:J.isoMode}),ge.add(Ve)}function dd(){if(!J.showIsosurfaces){Ve&&(ge.remove(Ve),Fu(Ve),Ve=null);return}const i=Number(J.isoResolution),t=J.maxDegree;rc(t,i)&&ro(),Ve&&Ev(Ve,J.isoOpacity),De(J,fe)}function ac(){!J.showInnerBelt&&!J.showOuterBelt||!ke||(md(),De(J,fe))}function fd(){var t,e,n;const i=new sn;if((t=ke==null?void 0:ke.g)!=null&&t[1]){const s=ke.g[1][0],r=ke.g[1][1],o=((n=(e=ke.h)==null?void 0:e[1])==null?void 0:n[1])??0,a=new O(-r,-s,-o).normalize();i.setFromUnitVectors(new O(0,1,0),a)}return i}function pd(){Qs&&Qs.mesh.quaternion.copy(fd())}function md(){if(Fe&&(ge.remove(Fe),Ou(Fe),Fe=null),!J.showInnerBelt&&!J.showOuterBelt)return;const i=J.sunLongitude*Math.PI/180,t=Mo.getActivePlanes(J.clipEquatorial,J.clipMeridional);Fe=Lv({showInnerBelt:J.showInnerBelt,showOuterBelt:J.showOuterBelt,clippingPlanes:t,opacity:J.beltOpacity,sunDirX:Math.cos(i),sunDirZ:Math.sin(i),stormIntensity:Math.min(1,Math.abs(J.dst)/150)}),Fe.quaternion.copy(fd()),ge.add(Fe),pd()}function RM(){if(!J.showInnerBelt&&!J.showOuterBelt){Fe&&(ge.remove(Fe),Ou(Fe),Fe=null);return}md(),De(J,fe)}function gd(){Mo.setMeridionalAngle(J.clipMeridionalAngle);const i=Mo.getActivePlanes(J.clipEquatorial,J.clipMeridional);Ve&&Av(Ve,i),Fe&&Uv(Fe,i),Pe&&Pe.traverse(t=>{t.material&&(t.material.clippingPlanes=i,t.material.needsUpdate=!0)}),De(J,fe)}function wa(i,t){let e=document.getElementById("iso-loading");!e&&i&&(e=document.createElement("div"),e.id="iso-loading",e.style.cssText="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);color:#fff;font-family:monospace;font-size:14px;background:rgba(0,0,0,0.7);padding:12px 24px;border-radius:8px;z-index:1000;pointer-events:none;",document.body.appendChild(e)),e&&(e.textContent=t||"Computing...",e.style.display=i?"block":"none")}function PM(i,t){const e=document.getElementById("iso-loading");e&&(e.textContent=`Computing ${t} field... ${i}%`)}const Ys=120,LM=300,Yr=289;let ti=null,ji=null,Zi=null,Uh=null,Nh=null;const DM=800,IM=i=>i*i*(3-2*i),UM=i=>i*i*i;let jn=null,Pl=null;function _d(i){ti=new Date(i),ti.setUTCHours(0,0,0,0);const t=new Float32Array(Yr),e=new Float32Array(Yr*3),n=new Float32Array(Yr*3);for(let l=0;l<Yr;l++){const c=l*LM;t[l]=c;const h=new Date(ti.getTime()+c*1e3),u=P1(h),d=Math.cos(u.declinationRad);e[l*3]=d*Math.cos(u.longitudeRad)*Ys,e[l*3+1]=Math.sin(u.declinationRad)*Ys,e[l*3+2]=d*Math.sin(u.longitudeRad)*Ys;const p=L1(h),g=Math.cos(p.declinationRad);n[l*3]=g*Math.cos(p.longitudeRad)*p.distanceEarthRadii,n[l*3+1]=Math.sin(p.declinationRad)*p.distanceEarthRadii,n[l*3+2]=g*Math.sin(p.longitudeRad)*p.distanceEarthRadii}ji==null||ji.stopAllAction();const s=new gs(".position",t,e),r=new mo("sun-day",86400,[s]);ji=new Gc($s.group),Uh=ji.clipAction(r),Uh.play(),Zi==null||Zi.stopAllAction();const o=new gs(".position",t,n),a=new mo("moon-day",86400,[o]);Zi=new Gc(Ih.mesh),Nh=Zi.clipAction(a),Nh.play(),$s.group.visible=!0,Ih.setVisible(!0)}function vd(i){const t=(i.getTime()-ti.getTime())/1e3;ji.setTime(t),$s.group.visible=!0,SM.position.copy($s.group.position).multiplyScalar(5/Ys);const e=$s.group.position;J.sunLongitude=(Math.atan2(e.z,e.x)*180/Math.PI+360)%360,J.sunDeclination=Math.asin(e.y/Ys)*180/Math.PI,Zi.setTime(t)}function Ll(i=!1){const t=new Date(J.datetimeString);if(isNaN(t.getTime()))return;rd(t);const e=new Date(t);e.setUTCHours(0,0,0,0),(!ti||e.getTime()!==ti.getTime())&&_d(t),vd(t),J.solarWindEnabled&&(Io(i?8200:1e3,!i),J.showIsosurfaces&&oc(),(J.showInnerBelt||J.showOuterBelt)&&ac(),J.showMagnetopause&&lc()),J.satellites.enabled&&he&&(_s=0),De(J,fe)}function xd(i){Sx(i);const t=Wu(i);t&&(t.vSw!==null&&(J.solarWindSpeed=Math.min(800,Math.max(300,Math.round(t.vSw)))),t.nSw!==null&&(J.solarWindDensity=Math.min(30,Math.max(1,Math.round(t.nSw*10)/10))),t.By!==null&&(J.imfBy=Math.min(20,Math.max(-20,Math.round(t.By*10)/10))),t.Bz!==null&&(J.imfBz=Math.min(20,Math.max(-20,Math.round(t.Bz*10)/10))),t.Dst!==null&&(J.dst=Math.min(50,Math.max(-200,Math.round(t.Dst)))),t.G1!==null&&(J.g1=Math.max(0,t.G1)),t.G2!==null&&(J.g2=Math.max(0,t.G2)),J._solarPreset="Historical Data",qM(),pe&&pe.updateKpBadge(Ro(Ai())))}function NM(i){const t=new Date(i);if(isNaN(t.getTime()))return;J.datetimeString=i,rd(t),zM(t);const e=new Date(t);e.setUTCHours(0,0,0,0),(!ti||e.getTime()!==ti.getTime())&&_d(t),vd(t);const n=Math.floor(t.getTime()/36e5)*3600;n!==Pl&&(Pl=n,xd(n))}function FM(){Io(1e3),J.showIsosurfaces&&oc(),(J.showInnerBelt||J.showOuterBelt)&&ac(),J.showMagnetopause&&lc(),pe&&pe.updateKpBadge(Ro(Ai())),De(J,fe)}let mi=null,Qs=null,Dl=null,Oe=null,he=null,fn=null,Md=0,_s=0,Un=-1,yd=0;const Ca=new Map,Kr=new Map;let Ra=null;function OM(i,t){const e=`${i}-${String(t).padStart(2,"0")}`;if(Ca.has(e))return Promise.resolve(Ca.get(e));if(Kr.has(e))return Kr.get(e);const n=fetch(`./data/tles/${e}.json`).then(s=>s.ok?s.json():null).catch(()=>null).then(s=>(Ca.set(e,s),Kr.delete(e),s));return Kr.set(e,n),n}function BM(i){if(!(i!=null&&i.tles)||!Oe)return;const t=i.tles;for(const e of Oe.satellites){const n=t[String(e.id)];n&&(e.line1=n[0],e.line2=n[1])}fn&&(fn.terminate(),fn=null,ir().postMessage({type:"init",satellites:Oe.satellites}),_s=0)}function zM(i){if(!J.satellites.enabled||!Oe)return;const t=`${i.getUTCFullYear()}-${String(i.getUTCMonth()+1).padStart(2,"0")}`;t!==Ra&&(Ra=t,OM(i.getUTCFullYear(),i.getUTCMonth()+1).then(e=>{e&&t===Ra&&BM(e)}))}function Sd(i){return(i.getTime()+631152e6)/864e5}function kM(i){return i>=86400?200:i>=3600?500:i>=60?2e3:1e4}function ir(){return fn||(fn=new Worker("/workers/satelliteWorker.js"),fn.onmessage=VM,fn.onerror=i=>console.error("[SatWorker]",i.message)),fn}function VM(i){const{type:t,requestId:e}=i.data;if(t==="ready"){_s=0;return}if(t==="positions"){if(e!==Md)return;he&&(he.updatePositions(i.data.positions,i.data.count),Un>=0&&ke&&HM(i.data.positions,i.data.count));return}if(t==="orbit"){if(e!==yd)return;if(he&&i.data.points){const n=Oe==null?void 0:Oe.satellites[Un];he.setOrbitTrace(i.data.points,(n==null?void 0:n.orbitClass)??"leo")}return}}function HM(i,t){if(Un<0||Un>=t)return;const e=i[Un*3],n=i[Un*3+1],s=i[Un*3+2];if(n<-1)return;const r=6371.2,o=e*r,a=n*r,l=s*r,c=Math.sqrt(o*o+a*a+l*l),h=Math.acos(Math.max(-1,Math.min(1,a/c))),u=Math.atan2(l,o),d=Ai(),p=dx(c,h,u,ke,J.maxDegree,d),g=Ro(d),_=Bu(g,(d==null?void 0:d.dst)??0),m=Oe.satellites[Un],f=c-r,y=90-h*(180/Math.PI),M=u*(180/Math.PI);mx({latDeg:y,lonDeg:M,altitudeKm:f,bMagnitude:p.bMagnitude,lShell:p.lShell,region:p.region,saaProximity:p.saaProximity,kp:g,swEnabled:(d==null?void 0:d.enabled)??!1,innerFlux:_.innerFlux,outerFlux:_.outerFlux,slotFlux:_.slotFlux},m.name)}function GM(){if(!Oe||!he)return;const i=++Md,t=pe?new Date(pe.getSimTimeAt(0)):new Date(J.datetimeString);ir().postMessage({type:"propagate",requestId:i,ds50utc:Sd(t)})}function Fh(i){if(Un=i,he&&he.setSelected(i),i<0){delete J._satSelected,he&&he.clearOrbitTrace(),Hu(),De(J,fe);return}J._satSelected=Oe.satellites[i].id;const t=Oe.satellites[i],e=ec(t.line2);if(e>0){const n=++yd,s=pe?new Date(pe.getSimTimeAt(0)):new Date(J.datetimeString);ir().postMessage({type:"traceOrbit",requestId:n,satIndex:i,ds50utc:Sd(s),periodMin:e})}De(J,fe)}function WM(){if(!Oe)return;J.satellites.enabled?(he||(he=ju(ge,Oe.satellites),["leo","meo","geo","heo","other"].filter(t=>J.satellites[`show${t.charAt(0).toUpperCase()+t.slice(1)}`]),ir().postMessage({type:"init",satellites:Oe.satellites})),he&&he.applyVisibility(J.satellites),_s=0):(he&&(he.dispose(),he=null),fn&&(fn.terminate(),fn=null),Hu());const i=["leo","meo","geo","heo","other"].filter(t=>J.satellites[`show${t.charAt(0).toUpperCase()+t.slice(1)}`]);xM(i,J.satellites.notableOnly),De(J,fe)}function lc(){mi&&(ge.remove(mi),mi.traverse(i=>{i.geometry&&i.geometry.dispose(),i.material&&i.material.dispose()}),mi=null),!(!J.showMagnetopause||!J.solarWindEnabled)&&Td(async()=>{const{buildMagnetopauseMesh:i}=await import("./magnetopauseMesh-DGmr4uSV.js");return{buildMagnetopauseMesh:i}},[],import.meta.url).then(({buildMagnetopauseMesh:i})=>{mi=i(Ai()),mi&&ge.add(mi)})}function XM(){lc(),De(J,fe)}uv();let pe;const{refreshSolarWindControls:qM}=hv(J,{onRebuild:()=>{Io(1e3),De(J,fe)},onVisualChange:ad,onIsoRebuild:()=>oc(),onIsoVisualChange:dd,onClipChange:gd,onBeltRebuild:()=>ac(),onBeltVisualChange:RM,onSatelliteSwarmChange:WM,onSatelliteSearchOpen:()=>vM(),onSolarWindChange:FM,onMagnetopauseChange:XM,onParticleChange:()=>De(J,fe),onAuroraChange:()=>De(J,fe)});Dh&&(rM(J,Dh),dd());pe=gv({initialTime:new Date(J.datetimeString),onTimeChange:i=>NM(i),onPause:()=>{jn=null,Ll(!1)},onPeriodicRebuild:()=>{pe&&pe.getSpeed()>=3600||Ll(!0)},getSolarWindData:Wu});_x(()=>pe.refreshColors());window.addEventListener("resize",()=>{fe.aspect=window.innerWidth/window.innerHeight,fe.updateProjectionMatrix(),Hn.setSize(window.innerWidth,window.innerHeight)});let Oh=0;function bd(i=performance.now()){requestAnimationFrame(bd);const t=Math.min((i-Oh)/1e3,.1);if(Oh=i,pe&&pe.tick(i),wM(i),Qs&&Qs.update(t,Ai(),J.particles,(pe==null?void 0:pe.getSpeed())??1),Dl&&Dl.update(i/1e3,J.dst,J.aurora),J.satellites.enabled&&he){const e=kM((pe==null?void 0:pe.getSpeed())??1);i-_s>e&&(_s=i,GM()),he.lerpPositions(i),he.tickOrbitTrace(i)}if(Fe&&(J.showInnerBelt||J.showOuterBelt)){const e=Ai(),n=Ro(e),s=(e==null?void 0:e.dst)??J.dst,r=Bu(n,s),o=.02;pi.innerFlux+=o*(r.innerFlux-pi.innerFlux),pi.outerFlux+=o*(r.outerFlux-pi.outerFlux),pi.slotFlux+=o*(r.slotFlux-pi.slotFlux),Iv(Fe,pi,J.beltOpacity)}Do.update(),Hn.render(ge,fe)}async function $M(){await Promise.all([bM(),Gu(2025,11)]),fetch("./data/satellites.json").then(t=>t.json()).then(t=>{if(Oe=t,gM(t.satellites,{onSelect:Fh}),J.satellites.enabled&&(he=ju(ge,t.satellites),he.applyVisibility(J.satellites),ir().postMessage({type:"init",satellites:t.satellites})),rn._satSelected!==void 0){const e=hM(t.satellites,rn._satSelected);e>=0&&(MM(e),J.satellites.enabled&&Fh(e))}}).catch(t=>console.warn("[Satellites] Failed to load catalog:",t)),Qs=Kx(ge),pd(),Dl=nM(ge),dv("Solar wind: Qin-Denton/WGhour.d (2026)");const i=Math.floor(new Date(J.datetimeString).getTime()/1e3);xd(i),Pl=Math.floor(i/3600)*3600,pe.refreshColors(),Ll(),Io(),ad(),bd()}$M();export{Ae as B,en as D,go as E,we as F,xa as K,xu as M,Ee as a,sx as b,zu as c,rx as f};
